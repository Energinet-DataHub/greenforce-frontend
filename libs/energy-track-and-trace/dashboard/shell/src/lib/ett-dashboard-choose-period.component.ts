...
export class EttDashboardChoosePeriodComponent implements OnInit {
  @Output() periodChanged = new EventEmitter<ettDashboardPeriod>();
  ...
  form = new FormGroup({
    period: new FormControl<EttTimeAggregate | null>(null),
  ...
  ngOnInit(): void {
    ...
    this.form.controls.period.setValue(EttTimeAggregate.Month);
  }
  ...
  private daySelected() {
    ...
    this.periodChanged.emit({
      timeAggregate: EttTimeAggregate.Hour,
  ...
  private monthSelected() {
    ...
    if (monthsControl.value === 'last30days') {
      ...
      this.periodChanged.emit({ timeAggregate: EttTimeAggregate.Day, start, end });
      // Specific month
    } else {
      ...
      this.periodChanged.emit({
        timeAggregate: EttTimeAggregate.Day,
  ...
  private yearSelected() {
    ...
    this.periodChanged.emit({
      timeAggregate: EttTimeAggregate.Month,
