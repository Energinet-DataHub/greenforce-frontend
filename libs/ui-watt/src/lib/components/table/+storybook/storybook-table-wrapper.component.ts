...
@Component({
  ...
  selector: 'storybook-table-wrapper',
  templateUrl: 'storybook-table-wrapper.component.html',
})
export class StorybookTableWrapperComponent implements AfterViewInit {
