...
@Component({
  ...
  template: `
    ...
    >
      ...
      <ul>
        <li>
          'ON' signifies that the metering point is set to use electricity generated by another
          Production unit that you have an agreement with (through this system).
        </li>
        <li>
