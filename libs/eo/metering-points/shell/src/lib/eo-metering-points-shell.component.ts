...
@Component({
  ...
  standalone: true,
  imports: [AsyncPipe, NgIf, EoMeteringPointsTableComponent, WATT_CARD, WattValidationMessageComponent],
  ...
  template: `
    <watt-validation-message label="You have the option to switch your metering points ON and OFF." size="normal" icon="info" [autoScrollIntoView]="false">
      ...
      <ul>
        <li>'ON' signifies that the metering point is set to use electricity generated by another Production unit that you have an agreement with (through this system).</li>
        <li>'OFF' indicates that the Consumption metering point will source its electricity from elsewhere.</li>
      </ul>
