  ...
  styles: [
    `
      ...
      ${selector} {
        ...
        .${selector}__link {
          display: inline-block;
          color: var(--watt-color-primary); // This overrides the '--watt-color-primary-dark' color which is currently added by the watt-text-s class
        }
        ...
        .${selector}__login-link {
          ...
          line-height: calc(
          var(--height) - 2 * var(--inset-squish-m--y)); // [3] [4]
  ...
  template: `
        ...
        <div class="${selector}__content">
            <div class="${selector}__one-column">
              <div class="watt-space-inset-xl">
                ...
                <p class="${selector}__p">Energy Origin is a platform which provides you with access to data about the origins of your energy and the corresponding emissions.<br><br>
      ...
      <div class="${selector}__content ${selector}__display-flex eo-padding-top-xl">
          <div class="${selector}__column--small watt-space-inset-l eo-padding-left-none">
            ...
            <p class="${selector}__p">Imagine if we all knew, where our energy came from, at all times, and were able to choose the green energy by the hour.
              ...
              <br><br>
              Simultaneity between production of sustainable energy and consumption of energy will be a real factor in the green transition
              and therefore has great potential for future green solutions.</p>
          </div>
          <div class="${selector}__column--large">
              <img class="${selector}__img" src="/assets/graph-of-energy-with-dashboard.png" alt="EnergyOrigin graph of energy" />
          </div>
      </div>
      ...
      <div class="${selector}__content ${selector}__display-flex eo-padding-top-xl">
          ...
          <div class="${selector}__column--small watt-space-inset-l">
            ...
            <p class="${selector}__p">This first version of Energy Origin is for companies in Denmark and can be used for e.g.:</p>
            <ul>
      ...
      <div class="${selector}__content ${selector}__display-flex eo-padding-top-xl eo-padding-bottom-xl">
          <div class="${selector}__column--small watt-space-inset-l eo-padding-left-none">
            ...
            <p class="${selector}__p">Energinet is an independent public enterprise owned by the Danish Ministry of Climate and Energy.
              We own, operate and develop the transmission systems for electricity and natural gas in Denmark.</p>
          </div>
          <div class="${selector}__column--large">
              <img class="${selector}__img" src="/assets/landing-page-energy-origin-energi-huset.jpg" alt="EnergyOrigin - Energihuset" />
          </div>
      </div>
