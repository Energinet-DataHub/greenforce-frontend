...
@Component({
  ...
  template: `
    ...
    <watt-expandable-card data-testid="own-transfer-agreements-card" class="watt-space-stack-m" [expanded]="true">
    ...
    <watt-expandable-card data-testid="transfer-agreements-from-poa-card" class="watt-space-stack-m">
