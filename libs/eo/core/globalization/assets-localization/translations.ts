...
export const translations = {
    ...
    footer: {
      ...
      section1: {
        ...
        content: {
          ...
          certificate:
            "landingPage.footer.section1.content.certificate" as const,
        } as const,
      } as const,
      section2: {
  ...
  shared: {
    ...
    empty: {
      title: "shared.empty.title" as const,
      message: "shared.empty.message" as const,
    } as const,
    chart: {
    ...
    paginator: {
      itemsPerPageLabel: "shared.paginator.itemsPerPageLabel" as const,
      of: "shared.paginator.of" as const,
      first: "shared.paginator.first" as const,
      last: "shared.paginator.last" as const,
      next: "shared.paginator.next" as const,
      previous: "shared.paginator.previous" as const,
      ariaLabel: "shared.paginator.ariaLabel" as const,
    } as const,
    fieldValidation: {
      required: "shared.fieldValidation.required" as const,
    } as const,
    search: "shared.search" as const,
    clipboard: {
      success: "shared.clipboard.success" as const,
      error: "shared.clipboard.error" as const,
    } as const,
  } as const,
  languageSwitcher: {
  ...
  meteringPoints: {
    ...
    cityTableHeader: "meteringPoints.cityTableHeader" as const,
    statusTableHeader: "meteringPoints.statusTableHeader" as const,
    ...
    selected: "meteringPoints.selected" as const,
    activate: "meteringPoints.activate" as const,
    deactivate: "meteringPoints.deactivate" as const,
    active: "meteringPoints.active" as const,
    inactive: "meteringPoints.inactive" as const,
  } as const,
  claims: {
    ...
    searchLabel: "claims.searchLabel" as const,
    tableTitle: "claims.tableTitle" as const,
  ...
  certificates: {
    title: "certificates.title" as const,
    noData: {
      title: "certificates.noData.title" as const,
      message: "certificates.noData.message" as const,
    } as const,
    error: {
      title: "certificates.error.title" as const,
      message: "certificates.error.message" as const,
    } as const,
    typeDropdown: "certificates.typeDropdown" as const,
    production: "certificates.production" as const,
    consumption: "certificates.consumption" as const,
    searchLabel: "certificates.searchLabel" as const,
    tableHeader: "certificates.tableHeader" as const,
    timeTableHeader: "certificates.timeTableHeader" as const,
    gsrnTableHeader: "certificates.gsrnTableHeader" as const,
    amountTableHeader: "certificates.amountTableHeader" as const,
    typeTableHeader: "certificates.typeTableHeader" as const,
  ...
  certificateDetails: {
    ...
    startTimeLabel: "certificateDetails.startTimeLabel" as const,
    endTimeLabel: "certificateDetails.endTimeLabel" as const,
    gsrnLabel: "certificateDetails.gsrnLabel" as const,
    certificateIdLabel: "certificateDetails.certificateIdLabel" as const,
    technologyHeadline: "certificateDetails.technologyHeadline" as const,
    technologyCodeLabel: "certificateDetails.technologyCodeLabel" as const,
    fuelCodeLabel: "certificateDetails.fuelCodeLabel" as const,
    backToCertificatesLink:
      "certificateDetails.backToCertificatesLink" as const,
    ...
    energyTag: {
      ...
      gcIssuanceDatestamp:
        "certificateDetails.energyTag.gcIssuanceDatestamp" as const,
      gcIssueDeviceType:
        "certificateDetails.energyTag.gcIssueDeviceType" as const,
      gcIssueMarketZone:
        "certificateDetails.energyTag.gcIssueMarketZone" as const,
      gcIssuer: "certificateDetails.energyTag.gcIssuer" as const,
      productionDeviceCapacity:
        "certificateDetails.energyTag.productionDeviceCapacity" as const,
      productionDeviceCommercialOperationDate:
        "certificateDetails.energyTag.productionDeviceCommercialOperationDate" as const,
      productionDeviceLocation:
        "certificateDetails.energyTag.productionDeviceLocation" as const,
  ...
  activityLog: {
    ...
    noData: {
      title: "activityLog.noData.title" as const,
      message: "activityLog.noData.message" as const,
    } as const,
    error: {
    ...
    events: {
      own: {
        MeteringPoint: {
          Created: "activityLog.events.own.MeteringPoint.Created" as const,
          Accepted: "activityLog.events.own.MeteringPoint.Accepted" as const,
          Declined: "activityLog.events.own.MeteringPoint.Declined" as const,
          Activated: "activityLog.events.own.MeteringPoint.Activated" as const,
          Deactivated:
            "activityLog.events.own.MeteringPoint.Deactivated" as const,
          EndDateChanged:
            "activityLog.events.own.MeteringPoint.EndDateChanged" as const,
          Expired: "activityLog.events.own.MeteringPoint.Expired" as const,
        } as const,
        TransferAgreementProposal: {
          Created:
            "activityLog.events.own.TransferAgreementProposal.Created" as const,
          Accepted:
            "activityLog.events.own.TransferAgreementProposal.Accepted" as const,
          Declined:
            "activityLog.events.own.TransferAgreementProposal.Declined" as const,
          Activated:
            "activityLog.events.own.TransferAgreementProposal.Activated" as const,
          Deactivated:
            "activityLog.events.own.TransferAgreementProposal.Deactivated" as const,
          EndDateChanged:
            "activityLog.events.own.TransferAgreementProposal.EndDateChanged" as const,
          Expired:
            "activityLog.events.own.TransferAgreementProposal.Expired" as const,
        } as const,
        TransferAgreement: {
          Created: "activityLog.events.own.TransferAgreement.Created" as const,
          Accepted:
            "activityLog.events.own.TransferAgreement.Accepted" as const,
          Declined:
            "activityLog.events.own.TransferAgreement.Declined" as const,
          Activated:
            "activityLog.events.own.TransferAgreement.Activated" as const,
          Deactivated:
            "activityLog.events.own.TransferAgreement.Deactivated" as const,
          EndDateChanged:
            "activityLog.events.own.TransferAgreement.EndDateChanged" as const,
          Expired: "activityLog.events.own.TransferAgreement.Expired" as const,
        } as const,
      } as const,
      others: {
        MeteringPoint: {
          Created: "activityLog.events.others.MeteringPoint.Created" as const,
          Accepted: "activityLog.events.others.MeteringPoint.Accepted" as const,
          Declined: "activityLog.events.others.MeteringPoint.Declined" as const,
          Activated:
            "activityLog.events.others.MeteringPoint.Activated" as const,
          Deactivated:
            "activityLog.events.others.MeteringPoint.Deactivated" as const,
          EndDateChanged:
            "activityLog.events.others.MeteringPoint.EndDateChanged" as const,
          Expired: "activityLog.events.others.MeteringPoint.Expired" as const,
        } as const,
        TransferAgreementProposal: {
          Created:
            "activityLog.events.others.TransferAgreementProposal.Created" as const,
          Accepted:
            "activityLog.events.others.TransferAgreementProposal.Accepted" as const,
          Declined:
            "activityLog.events.others.TransferAgreementProposal.Declined" as const,
          Activated:
            "activityLog.events.others.TransferAgreementProposal.Activated" as const,
          Deactivated:
            "activityLog.events.others.TransferAgreementProposal.Deactivated" as const,
          EndDateChanged:
            "activityLog.events.others.TransferAgreementProposal.EndDateChanged" as const,
          Expired:
            "activityLog.events.others.TransferAgreementProposal.Expired" as const,
        } as const,
        TransferAgreement: {
          Created:
            "activityLog.events.others.TransferAgreement.Created" as const,
          Accepted:
            "activityLog.events.others.TransferAgreement.Accepted" as const,
          Declined:
            "activityLog.events.others.TransferAgreement.Declined" as const,
          Activated:
            "activityLog.events.others.TransferAgreement.Activated" as const,
          Deactivated:
            "activityLog.events.others.TransferAgreement.Deactivated" as const,
          EndDateChanged:
            "activityLog.events.others.TransferAgreement.EndDateChanged" as const,
          Expired:
            "activityLog.events.others.TransferAgreement.Expired" as const,
        } as const,
      } as const,
    } as const,
  } as const,
    ...
    overview: {
      ...
      modal: {
        ...
        segment: {
          ...
          yearExplainer:
            "reports.overview.modal.segment.yearExplainer" as const,
          financialYear:
            "reports.overview.modal.segment.financialYear" as const,
          financialYearExplainer:
            "reports.overview.modal.segment.financialYearExplainer" as const,
  ...
  transfers: {
    ...
    creationOfTransferAgreementFailed:
      "transfers.creationOfTransferAgreementFailed" as const,
    ...
    transferAgreementStatusFilterLabel:
      "transfers.transferAgreementStatusFilterLabel" as const,
    ...
    expiredTransferAgreementProposals:
      "transfers.expiredTransferAgreementProposals" as const,
    noData: {
  ...
  transferAgreement: {
    active: "transferAgreement.active" as const,
    inactive: "transferAgreement.inactive" as const,
    editTransferAgreement: "transferAgreement.editTransferAgreement" as const,
  ...
  transferAgreementEdit: {
    ...
    closeLabel: "transferAgreementEdit.closeLabel" as const,
    cancel: "transferAgreementEdit.cancel" as const,
    saveChanges: "transferAgreementEdit.saveChanges" as const,
    error: {
      title: "transferAgreementEdit.error.title" as const,
      message: "transferAgreementEdit.error.message" as const,
    } as const,
  } as const,
  createTransferAgreementProposal: {
    ...
    parties: {
      ...
      titleBetween:
        "createTransferAgreementProposal.parties.titleBetween" as const,
      description:
        "createTransferAgreementProposal.parties.description" as const,
      nextLabel: "createTransferAgreementProposal.parties.nextLabel" as const,
      unknownParty:
        "createTransferAgreementProposal.parties.unknownParty" as const,
      senderTinLabel:
        "createTransferAgreementProposal.parties.senderTinLabel" as const,
      senderTinPlaceholder:
        "createTransferAgreementProposal.parties.senderTinPlaceholder" as const,
      senderTinGeneralError:
        "createTransferAgreementProposal.parties.senderTinGeneralError" as const,
      tinFormatError:
        "createTransferAgreementProposal.parties.tinFormatError" as const,
      receiverTinLabel:
        "createTransferAgreementProposal.parties.receiverTinLabel" as const,
    ...
    timeframe: {
      ...
      title: "createTransferAgreementProposal.timeframe.title" as const,
      description:
        "createTransferAgreementProposal.timeframe.description" as const,
      nextLabel: "createTransferAgreementProposal.timeframe.nextLabel" as const,
      previousLabel:
        "createTransferAgreementProposal.timeframe.previousLabel" as const,
      startDate: {
        label:
          "createTransferAgreementProposal.timeframe.startDate.label" as const,
        required:
          "createTransferAgreementProposal.timeframe.startDate.required" as const,
        nextHourOrLater:
          "createTransferAgreementProposal.timeframe.startDate.nextHourOrLater" as const,
        overlapping:
          "createTransferAgreementProposal.timeframe.startDate.overlapping" as const,
      } as const,
      endDate: {
        label:
          "createTransferAgreementProposal.timeframe.endDate.label" as const,
        noEndDateLabel:
          "createTransferAgreementProposal.timeframe.endDate.noEndDateLabel" as const,
        withEndDateLabel:
          "createTransferAgreementProposal.timeframe.endDate.withEndDateLabel" as const,
        minToday:
          "createTransferAgreementProposal.timeframe.endDate.minToday" as const,
        laterThanStartDate:
          "createTransferAgreementProposal.timeframe.endDate.laterThanStartDate" as const,
        withEndDateOverlapping:
          "createTransferAgreementProposal.timeframe.endDate.withEndDateOverlapping" as const,
    ...
    volume: {
      ...
      matchReceiver:
        "createTransferAgreementProposal.volume.matchReceiver" as const,
      ...
      previousLabel:
        "createTransferAgreementProposal.volume.previousLabel" as const,
    } as const,
    summary: {
      stepLabel: "createTransferAgreementProposal.summary.stepLabel" as const,
      previousLabel:
        "createTransferAgreementProposal.summary.previousLabel" as const,
      ready: {
        title: "createTransferAgreementProposal.summary.ready.title" as const,
        nextLabel:
          "createTransferAgreementProposal.summary.ready.nextLabel" as const,
      } as const,
      invitation: {
        title: {
          success:
            "createTransferAgreementProposal.summary.invitation.title.success" as const,
          error:
            "createTransferAgreementProposal.summary.invitation.title.error" as const,
        } as const,
        description: {
          success:
            "createTransferAgreementProposal.summary.invitation.description.success" as const,
          error:
            "createTransferAgreementProposal.summary.invitation.description.error" as const,
        } as const,
        link: {
          ...
          error:
            "createTransferAgreementProposal.summary.invitation.link.error" as const,
          copy: "createTransferAgreementProposal.summary.invitation.link.copy" as const,
          retry:
            "createTransferAgreementProposal.summary.invitation.link.retry" as const,
        } as const,
        nextLabel:
          "createTransferAgreementProposal.summary.invitation.nextLabel" as const,
      } as const,
    } as const,
  } as const,
  respondTransferAgreementProposal: {
    title: "respondTransferAgreementProposal.title" as const,
    loadingMessage: "respondTransferAgreementProposal.loadingMessage" as const,
    closeLabel: "respondTransferAgreementProposal.closeLabel" as const,
    noEndDate: "respondTransferAgreementProposal.noEndDate" as const,
    success: {
      title: "respondTransferAgreementProposal.success.title" as const,
      message: "respondTransferAgreementProposal.success.message" as const,
      acceptButton:
        "respondTransferAgreementProposal.success.acceptButton" as const,
      declineButton:
        "respondTransferAgreementProposal.success.declineButton" as const,
    } as const,
    error: {
      ...
      declineButton:
        "respondTransferAgreementProposal.error.declineButton" as const,
    } as const,
  } as const,
  consent: {
  ...
  consentPermissions: {
    permissions: {
      overview: {
        ...
        description:
          "consentPermissions.permissions.overview.description" as const,
      } as const,
      meteringPoints: {
        title: "consentPermissions.permissions.meteringPoints.title" as const,
        description:
          "consentPermissions.permissions.meteringPoints.description" as const,
      } as const,
      transferAgreements: {
        title:
          "consentPermissions.permissions.transferAgreements.title" as const,
        description:
          "consentPermissions.permissions.transferAgreements.description" as const,
      } as const,
    } as const,
