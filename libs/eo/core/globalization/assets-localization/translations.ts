...
export const translations = {
  ...
  shared: {
    ...
    chart: {
      ...
      activateMeteringPointsAction: 'shared.chart.activateMeteringPointsAction' as const,
  ...
  producerChart: {
    ...
    activateMeteringPointsAction: 'producerChart.activateMeteringPointsAction' as const,
    legends: {
  ...
  consumerChart: {
    ...
    activateMeteringPointsAction: 'consumerChart.activateMeteringPointsAction' as const,
    legends: {
    ...
    events: {
      own: {
        MeteringPoint: {
          ...
          Deactivated: 'activityLog.events.own.MeteringPoint.Deactivated' as const,
          EndDateChanged: 'activityLog.events.own.MeteringPoint.EndDateChanged' as const,
          Expired: 'activityLog.events.own.MeteringPoint.Expired' as const,
        } as const,
        TransferAgreementProposal: {
          Created: 'activityLog.events.own.TransferAgreementProposal.Created' as const,
          Accepted: 'activityLog.events.own.TransferAgreementProposal.Accepted' as const,
          Declined: 'activityLog.events.own.TransferAgreementProposal.Declined' as const,
          Activated: 'activityLog.events.own.TransferAgreementProposal.Activated' as const,
          Deactivated: 'activityLog.events.own.TransferAgreementProposal.Deactivated' as const,
          EndDateChanged:
            'activityLog.events.own.TransferAgreementProposal.EndDateChanged' as const,
          Expired: 'activityLog.events.own.TransferAgreementProposal.Expired' as const,
        } as const,
        TransferAgreement: {
          Created: 'activityLog.events.own.TransferAgreement.Created' as const,
          Accepted: 'activityLog.events.own.TransferAgreement.Accepted' as const,
          Declined: 'activityLog.events.own.TransferAgreement.Declined' as const,
          Activated: 'activityLog.events.own.TransferAgreement.Activated' as const,
          Deactivated: 'activityLog.events.own.TransferAgreement.Deactivated' as const,
          EndDateChanged: 'activityLog.events.own.TransferAgreement.EndDateChanged' as const,
      ...
      others: {
        MeteringPoint: {
          ...
          Activated: 'activityLog.events.others.MeteringPoint.Activated' as const,
          Deactivated: 'activityLog.events.others.MeteringPoint.Deactivated' as const,
          EndDateChanged: 'activityLog.events.others.MeteringPoint.EndDateChanged' as const,
          Expired: 'activityLog.events.others.MeteringPoint.Expired' as const,
        } as const,
        TransferAgreementProposal: {
          Created: 'activityLog.events.others.TransferAgreementProposal.Created' as const,
          Accepted: 'activityLog.events.others.TransferAgreementProposal.Accepted' as const,
          Declined: 'activityLog.events.others.TransferAgreementProposal.Declined' as const,
          Activated: 'activityLog.events.others.TransferAgreementProposal.Activated' as const,
          Deactivated: 'activityLog.events.others.TransferAgreementProposal.Deactivated' as const,
          EndDateChanged:
            'activityLog.events.others.TransferAgreementProposal.EndDateChanged' as const,
          Expired: 'activityLog.events.others.TransferAgreementProposal.Expired' as const,
        } as const,
        TransferAgreement: {
          Created: 'activityLog.events.others.TransferAgreement.Created' as const,
          Accepted: 'activityLog.events.others.TransferAgreement.Accepted' as const,
          Declined: 'activityLog.events.others.TransferAgreement.Declined' as const,
          Activated: 'activityLog.events.others.TransferAgreement.Activated' as const,
          Deactivated: 'activityLog.events.others.TransferAgreement.Deactivated' as const,
    ...
    overview: {
      ...
      modal: {
        ...
        segment: {
          ...
          yearExplainer: 'reports.overview.modal.segment.yearExplainer' as const,
          financialYear: 'reports.overview.modal.segment.financialYear' as const,
          financialYearExplainer: 'reports.overview.modal.segment.financialYearExplainer' as const,
  ...
  createTransferAgreementProposal: {
    ...
    timeframe: {
      ...
      description: 'createTransferAgreementProposal.timeframe.description' as const,
      nextLabel: 'createTransferAgreementProposal.timeframe.nextLabel' as const,
      previousLabel: 'createTransferAgreementProposal.timeframe.previousLabel' as const,
      startDate: {
        label: 'createTransferAgreementProposal.timeframe.startDate.label' as const,
        required: 'createTransferAgreementProposal.timeframe.startDate.required' as const,
        nextHourOrLater:
          'createTransferAgreementProposal.timeframe.startDate.nextHourOrLater' as const,
        overlapping: 'createTransferAgreementProposal.timeframe.startDate.overlapping' as const,
      } as const,
      endDate: {
        label: 'createTransferAgreementProposal.timeframe.endDate.label' as const,
        noEndDateLabel: 'createTransferAgreementProposal.timeframe.endDate.noEndDateLabel' as const,
        withEndDateLabel:
          'createTransferAgreementProposal.timeframe.endDate.withEndDateLabel' as const,
        minToday: 'createTransferAgreementProposal.timeframe.endDate.minToday' as const,
        laterThanStartDate:
  ...
  respondTransferAgreementProposal: {
    ...
    success: {
      ...
      acceptButton: 'respondTransferAgreementProposal.success.acceptButton' as const,
      declineButton: 'respondTransferAgreementProposal.success.declineButton' as const,
    } as const,
    error: {
