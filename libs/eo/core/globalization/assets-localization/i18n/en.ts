    ...
    events: {
      own: {
        ...
        TransferAgreementProposal: {
          Created: '{{actorName}} has created a proposal of a transfer agreement with ID {{entityId}}',
          Accepted:
          ...
          Expired: '{{actorName}} has expired the proposal of a transfer agreement with ID {{entityId}}',
        },
        TransferAgreement: {
          Created: '{{actorName}} has created a transfer agreement with ID {{entityId}}',
          Accepted: '{{actorName}} has accepted the transfer agreement from {{otherOrganizationName}} ({{otherOrganizationTin}}) with ID {{entityId}}',
      ...
      others: {
        MeteringPoint: {
          Created: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has created a metering point with ID {{entityId}}',
          Accepted: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has accepted the metering point with ID {{entityId}}',
          Declined: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has declined the metering point with ID {{entityId}}',
          Activated: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has activated the metering point with ID {{entityId}}',
          Deactivated: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has deactivated the metering point with ID {{entityId}}',
          EndDateChanged:
          ...
          Expired: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has expired the metering point with ID {{entityId}}',
        },
        TransferAgreementProposal: {
          Created: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has created a proposal of a transfer agreement with ID {{entityId}}',
          Accepted:
          ...
          Expired: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has expired the proposal of a transfer agreement with ID {{entityId}}',
        },
        TransferAgreement: {
          Created: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has created a transfer agreement with ID {{entityId}}',
          Accepted: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has accepted the transfer agreement with ID {{entityId}}',
          Declined: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has declined the transfer agreement with ID {{entityId}}',
          Activated: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has activated the transfer agreement with ID {{entityId}}',
          Deactivated: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has deactivated the transfer agreement with ID {{entityId}}',
          EndDateChanged:
            '{{otherOrganizationName}} ({{otherOrganizationTin}}) has changed the end date of the transfer agreement with ID {{entityId}}',
          Expired: '{{otherOrganizationName}} ({{otherOrganizationTin}}) has expired the transfer agreement with ID {{entityId}}',
        },
      },
    },
  },
