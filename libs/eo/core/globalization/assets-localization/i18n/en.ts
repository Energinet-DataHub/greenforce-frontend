...
export const EN_TRANSLATIONS: TranslationKeys = {
  ...
  shared: {
    notWhitelistedError: {
      title: 'No access',
      message: `You do not have access to issue Granular Guarantees of Origin, in this environment.<br /> If you think this is an error then contact support at <a href="tel:+4570222810">+45 70 22 28 10</a> or <a href="mailto:datahub@energinet.dk?cc=mil@energinet.dk">datahub@energinet.dk</a>.`,
      logout: 'Log out',
    },
  ...
  transfers: {
    ...
    creationOfTransferAgreementFailed: 'Creating the transfer agreement failed.',
