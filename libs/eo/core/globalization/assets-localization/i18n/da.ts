...
export const DA_TRANSLATIONS: TranslationKeys = {
  ...
  shared: {
    notWhiteListedError: {
      title: 'Ingen adgang',
      message:
        'Du har endnu ikke adgang til at udstede Granulære Oprindelsesgarantier.<br /> Kontakt support på tlf. <a href="tel:+4570222810">+45 70 22 28 10</a> eller <a href="mailto:datahub@energinet.dk">datahub@energinet.dk</a>.',
    },
  ...
  certificateDetails: {
    ...
    energyTag: {
      ...
      country: 'Land',
      energyCarrier: 'Energikilde',
      gcFaceValue: 'Mængde (Wh)',
      gcIssuanceDatestamp: 'Udstedelsesdato',
      gcIssueDeviceType: 'Udstedelsestype',
      gcIssueMarketZone: 'Budzone',
      gcIssuer: 'Udsteder',
  ...
  transfers: {
    ...
    tablePOAAgreementsTitle: 'Overførselsaftaler via fuldmagt',
