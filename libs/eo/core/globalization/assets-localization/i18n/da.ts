...
export const DA_TRANSLATIONS: TranslationKeys = {
  ...
  createTransferAgreementProposal: {
    ...
    parties: {
      ...
      recipientTinLabel: 'Modtager',
      recipientTinPlaceholder: 'CVR / TIN',
      recipientTinGeneralError:
        'Indtast nyt CVR-nummer eller vælg fra tidligere overførselsaftaler',
      recipientTinEqualsSenderTin: 'Modtageren kan ikke være dit eget TIN/CVR',
    },
    timeframe: {
      stepLabel: 'Tidsramme',
    ...
    volume: {
      ...
      stepLabel: 'Volumen',
      matchRecipient: 'Match modtagers forbrug',
