...
@Component({
  ...
  standalone: true,
  imports: [WattNavListComponent, WattNavListItemComponent, EoFeatureFlagDirective, AsyncPipe, NgIf],
  ...
  template: `
    <watt-nav-list>
      ...
      <watt-nav-list-item *ngIf="isLoggedIn$ | async" (click)="onLogOut()" role="link"> Log out </watt-nav-list-item>
    </watt-nav-list>
  `,
})
