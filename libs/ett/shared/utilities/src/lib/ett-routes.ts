 ...
 */
//#endregion
export const ettOnboardingRoutePath = 'onboarding';
export const ettCertificatesRoutePath = 'certificates';
export const ettContactSupportRoutePath = 'contact-support';
...
export const ettReportsRoutePath = 'reports';

export const ettRoutes = {
  onboarding: ettOnboardingRoutePath,
  certificates: ettCertificatesRoutePath,
  contactSupport: ettContactSupportRoutePath,
