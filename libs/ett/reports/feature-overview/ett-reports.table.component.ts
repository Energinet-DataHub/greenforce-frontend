...
import { EttReport, ReportStatus } from '@energinet-datahub/ett/reports/data-access-api';
...
export class EttReportsTableComponent implements OnInit {
  ...
  protected dataSource: WattTableDataSource<EttReport> = new WattTableDataSource(undefined);
  protected columns!: WattTableColumnDef<EttReport>;
