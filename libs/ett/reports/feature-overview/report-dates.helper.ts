...
import { EttReportDateRange } from './ett-start-report-generation.modal.component';
...
export function getWeekRange(week: string, year: string): EttReportDateRange {
...
export function getMonthRange(monthName: string, year: string): EttReportDateRange {
...
export function getYearRange(year: string): EttReportDateRange {
...
export function getFinancialYearRange(year: string): EttReportDateRange {
  const yearAsNumber = parseInt(year, 10);
