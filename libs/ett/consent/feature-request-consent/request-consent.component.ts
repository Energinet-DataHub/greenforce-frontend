...
@Component({
  ...
  selector: 'ett-request-consent-modal',
  imports: [
    WATT_MODAL,
    TranslocoPipe,
    WattButtonComponent,
  ...
  template: `
    @if (opened) {
      <watt-modal
        ...
        [panelClass]="['ett-request-consent-modal']"
      >
        ...
        @if (serviceProviderTermsService.serviceProviderTermsAccepted()) {
          ...
          <ett-html-doc class="service-provider-modal-margin" [path]="serviceProviderTermsPath" />
        }
...
export class EttRequestConsentModalComponent {
