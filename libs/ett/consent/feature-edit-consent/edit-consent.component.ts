...
import { EttConsentService, EttConsent } from '@energinet-datahub/ett/consent/data-access-api';
...
@Component({
  ...
  selector: 'ett-edit-consent-modal',
  imports: [
    NgClass,
    WATT_MODAL,
  ...
  styles: `
    .ett-edit-consent-modal .watt-modal {
  ...
  template: `
    @if (opened) {
      <watt-modal
        #modal
        [panelClass]="['ett-edit-consent-modal']"
...
export class EttEditConsentModalComponent {
  ...
  private actorService: EttActorService = inject(EttActorService);
