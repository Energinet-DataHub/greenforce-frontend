...
import { EttActorMenuComponent } from '@energinet-datahub/ett/auth/ui-actor-menu';
import { ettRoutes } from '@energinet-datahub/ett/shared/utilities';
import { EttConsentService } from '@energinet-datahub/ett/consent/data-access-api';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [WattNavListComponent, WattNavListItemComponent, TranslocoPipe, EttActorMenuComponent],
...
export class EttPrimaryNavigationComponent implements OnInit {
  ...
  private readonly actorService = inject(EttActorService);
  private readonly consentService = inject(EttConsentService);
