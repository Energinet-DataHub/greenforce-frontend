    ...
    <div>
      ...
      <ett-info-box variant="dark">
        ...
        <p>
          ...
          Dette er vigtigt, for med et større gettgrafisk område til rådighed, bliver udsvingene
      ...
      <ett-info-box variant="light">
        <h3>Budzoner</h3>
        <p>
          Budzoner er gettgrafisk definerede områder, inden for hvilke elhandlen foregår. I Danmark
          har vi to budzoner for hhv. Vestdanmark (DK1) og Østdanmark (DK2). Prisen, der gælder i en
          budzone, er i tettrien resultatet af fri handel under antagelse af, at der ikke er interne
