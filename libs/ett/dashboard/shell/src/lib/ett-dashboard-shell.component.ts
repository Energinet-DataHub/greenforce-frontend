...
export class EttDashboardShellComponent implements OnInit {
  private readonly meteringPointStore = inject(EttMeteringPointsStore);
  private readonly aggregateService: EttAggregateService = inject(EttAggregateService);
  ...
  ngOnInit(): void {
    ...
    this.productionAndConsumptionMeteringPoints$
      ...
      .subscribe((meteringPoints: EttMeteringPoint[]) => {
