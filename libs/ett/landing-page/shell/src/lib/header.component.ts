...
import { EttLoginButtonComponent } from './login-button.component';
...
@Component({
  ...
  template: `
    ...
    />
    <div class="topbar">
      <img ettProductLogo version="secondary" class="logo secondary" style="margin-top: -6px" />
      <img ettProductLogo class="logo primary" />

      <div class="actions">
        <ett-login-button type="text" />
