...
import { naming } from '@energinet-datahub/ett/shared/assets';
import { translations } from '@energinet-datahub/ett/translations';

import { EttLottieComponent } from './ett-lottie.component';

const selector = 'ett-landing-page-naming';
...
export class EttLandingPageNamingComponent implements AfterViewInit, OnDestroy {
