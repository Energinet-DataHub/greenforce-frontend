...
const selector = 'ett-actor-menu';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  imports: [TranslocoPipe, MatMenuModule, NgClass, EttScrollViewComponent, WattIconComponent],
  selector,
  styles: `
    ...
    .actor-menu-panel {
      ...
      --ett-scroll-view-max-height: 112px;
      width: 257px;
...
export class EttActorMenuComponent {
  actors = input<Actor[]>([]);
