...
@Component({
  ...
  selector: 'ett-metering-points-helper-modal',
  imports: [WATT_MODAL, TranslocoPipe],
  styles: `
    .ett-metering-points-helper-modal .watt-modal {
      ul {
  ...
  template: `
    @if (opened) {
      <watt-modal
        #modal
        [panelClass]="['ett-metering-points-helper-modal']"
...
export class EttMeteringPointsHelperModalComponent {
