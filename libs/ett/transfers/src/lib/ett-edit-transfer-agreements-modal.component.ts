...
@Component({
  ...
  imports: [WATT_MODAL, WattValidationMessageComponent, EttTransfersFormComponent, TranslocoPipe],
  template: `
    @if (opened) {
      <watt-modal
        #modal
...
export class EttEditTransferAgreementsModalComponent {
  ...
  protected initialValues = signal<EttTransfersFormInitialValues>({});
