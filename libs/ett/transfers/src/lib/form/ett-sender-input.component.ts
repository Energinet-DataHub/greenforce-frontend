...
@Component({
  selector: 'ett-sender-input',
  imports: [TranslocoPipe, WattDropdownComponent, ReactiveFormsModule],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => EttSenderInputComponent),
      multi: true,
    },
    {
      provide: NG_VALIDATORS,
      multi: true,
      useExisting: EttSenderInputComponent,
    },
  ],
  styles: [``],
...
export class EttSenderInputComponent implements ControlValueAccessor, Validator {
