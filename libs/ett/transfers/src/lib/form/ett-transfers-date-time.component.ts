...
import { ExistingTransferAgreement } from '../data/ett-transfer-agreement.types';

@Component({
  selector: 'ett-transfers-datetime',
  imports: [ReactiveFormsModule, EttTransfersTimepickerComponent, WattDatepickerComponent],
  styles: [
    `
      ...
      ett-transfers-datetime watt-datepicker {
        max-width: 160px;
