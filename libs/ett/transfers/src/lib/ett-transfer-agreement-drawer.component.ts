...
import { EttEditTransferAgreementsModalComponent } from './ett-edit-transfer-agreements-modal.component';
import { EttTransferAgreementsHistoryComponent } from './ett-transfer-agreements-history.component';
...
import { TransferAgreementValues } from './ett-transfer-agreements.component';
import { ListedTransferAgreement } from './data/ett-transfer-agreement.types';
...
@Component({
  ...
  imports: [
    ...
    WattTabComponent,
    WattDatePipe,
    EttEditTransferAgreementsModalComponent,
    EttTransferAgreementsHistoryComponent,
          ...
          <watt-tabs #tabs>
            ...
            <watt-tab [label]="translations.transferAgreement.historyTab | transloco">
              @if (tabs.activeTabIndex === 1) {
                <ett-transfers-history #history [transferAgreement]="transfer()" />
              }
            </watt-tab>
          </watt-tabs>
        </watt-drawer-content>
...
export class EttTransferAgreementDrawerComponent {
  @ViewChild(WattDrawerComponent) drawer!: WattDrawerComponent;
  @ViewChild(EttEditTransferAgreementsModalComponent)
  transfersEditModal!: EttEditTransferAgreementsModalComponent;
  @ViewChild(EttTransferAgreementsHistoryComponent) history!: EttTransferAgreementsHistoryComponent;
