...
import { EttTransferAgreementDrawerComponent } from './ett-transfer-agreement-drawer.component';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';
import {
  EttTransferTableElement,
  TransferAgreementValues,
} from './ett-transfer-agreements.component';
...
@Component({
  ...
  imports: [
    ...
    ReactiveFormsModule,
    EttTransferAgreementDrawerComponent,
    WattDatePipe,
    TranslocoPipe,
  ],
  styles: [
...
export class EttTransferAgreementsTableComponent implements OnInit {
  transferAgreements = input.required<ListedTransferAgreement[]>();
  loading = input<boolean>(false);
  selectedTransferAgreement = input<ListedTransferAgreement>();
  dataSource = input.required<WattTableDataSource<EttTransferTableElement>>();
  ...
  @ViewChild(EttTransferAgreementDrawerComponent)
  transferAgreementsDrawer!: EttTransferAgreementDrawerComponent;
