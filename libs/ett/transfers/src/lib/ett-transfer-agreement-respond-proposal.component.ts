...
import { TransferAgreementProposal } from './data/ett-transfer-agreement.types';

@Component({
  selector: 'ett-transfers-respond-proposal',
...
export class EttTransferAgreementRespondProposalComponent {
