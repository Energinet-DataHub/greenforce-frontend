...
| ---------- | --- | ----------- |
| Angular Material | `setUpTestbed` | Disable theme check because it always fails in Vitest tests.<br>Fake the icon registry to enable verification of SVG icons. |
| Angular Testing Library | `setUpAngularTestingLibrary` | Assume SCAMs and require semantic queries. |
| ng-mocks | `setUpNgMocks` | Support Vitest. |
| RxAngular Template | `setUpTestbed` | Support Vitest. |
