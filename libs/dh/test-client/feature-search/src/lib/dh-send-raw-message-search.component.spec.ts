...
import { dhSendMessageIdParam } from '../lib/routing/dh-send-message-param';
import { en as enTranslations } from '@energinet-datahub/dh/globalization/assets-localization';
import { getTranslocoTestingModule } from '@energinet-datahub/dh/shared/test-util-i18n';

import {
  DhSendMessageComponent,
  DhSendMessageScam,
} from './dh-send-message.component';
...
describe(DhSendMessageComponent.name, () => {
  async function setup() {
    const { fixture } = await render(DhSendMessageComponent, {
      imports: [
      ...
      routes: [
        { path: `:${dhSendMessageIdParam}`, component: NoopComponent },
      ],
    });
