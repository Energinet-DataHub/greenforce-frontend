...
//
// import {
//   DhProcessItemComponent,
//   DhProcessItemScam,
// } from './dh-process-item.component';
//
...
// ];
//
// describe(DhProcessItemComponent.name, () => {
//   async function setup(charges: Array<ChargeLinkDto>, title?: string) {
//     const { fixture } = await render(DhProcessItemComponent, {
//       componentProperties: {
//         processes: charges,
//         title: title,
//       },
//       imports: [getTranslocoTestingModule(), DhProcessItemScam],
//     });
//
