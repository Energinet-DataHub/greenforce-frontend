  ...
  template: `
    ...
    >
      ...
      <watt-modal-actions>
        ...
        <dh-generate-client-secret [actorId]="data.actorId" (generateSuccess)="modal.close(true)" />
      </watt-modal-actions>
    </watt-modal>
  `,
  imports: [TranslocoDirective, WATT_MODAL, WattButtonComponent, DhGenerateClientSecretComponent],
})
export class DhReplaceCertificateModalComponent extends StronglyTypedDialog<{ actorId: string }> {}
