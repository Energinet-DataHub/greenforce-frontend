  ...
  template: `
    ...
    >
      ...
      <watt-modal-actions>
        ...
        <dh-certificate-uploader [actorId]="data.actorId" (uploadSuccess)="modal.close(true)" />
      </watt-modal-actions>
    </watt-modal>
  `,
  imports: [TranslocoDirective, WATT_MODAL, WattButtonComponent, DhCertificateUploaderComponent],
})
export class DhReplaceClientSecretModalComponent extends StronglyTypedDialog<{ actorId: string }> {}
