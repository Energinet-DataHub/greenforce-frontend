...
const commercialRelation: ElectricityMarketViewCommercialRelationDto = {
  ...
  activeElectricalHeatingPeriods: {
    ...
    isActive: true,
    transactionType: ElectricityMarketViewTransactionType.ElectricalHeatingOn,
  },
  ...
  activeEnergySupplyPeriod: {
    ...
    customers: [
      ...
      },
      {
        ...
        legalContact: null,
        technicalContact: null,
        relationType: ElectricityMarketViewCustomerRelationType.Secondary,
      },
    ],
  },
};
...
export const parentMeteringPoint: ElectricityMarketViewMeteringPointDto = {
