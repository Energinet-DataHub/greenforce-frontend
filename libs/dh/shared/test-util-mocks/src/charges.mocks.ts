...
const chargeLinkOverviewItems: ChargeLinkOverviewItem[] = [
  {
    ...
    displayPeriod: { start: new Date('2023-01-01T00:00:00Z'), end: null },
    closed: true,
    charge: charges[0],
  },
  {
    ...
    amount: 75,
    period: { start: new Date('2023-01-01T00:00:00Z'), end: new Date('2023-12-31T23:59:59Z') },
    displayPeriod: { start: new Date('2023-01-01T00:00:00Z'), end: new Date('2023-12-31T23:59:59Z') },
    closed: true,
    charge: charges[1],
  },
  {
    ...
    displayPeriod: { start: new Date('2023-03-01T00:00:00Z'), end: new Date('2023-09-30T23:59:59Z') },
    closed: true,
    charge: charges[2],
  },
  {
    ...
    displayPeriod: { start: new Date('2023-04-01T00:00:00Z'), end: null },
    closed: true,
    charge: charges[3],
  },
  {
  ...
  },
  {
    ...
    displayPeriod: { start: new Date('2026-03-18T23:00:00.000Z'), end: null },
    closed: false,
    charge: charges[0],
  },
];
