...
import { GridAreaOverviewItemDto } from '../model/models';
...
export class MarketParticipantGridAreaOverviewHttp {
    ...
    public v1MarketParticipantGridAreaOverviewGet(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GridAreaOverviewItemDto>>(`${this.configuration.basePath}/v1/MarketParticipantGridAreaOverview`,
            {
