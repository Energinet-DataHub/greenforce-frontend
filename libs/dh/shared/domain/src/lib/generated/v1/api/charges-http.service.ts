...
import { SearchCriteriaV1Dto } from '../model/models';
...
export class ChargesHttp {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v1ChargesGetMarketParticipantsAsyncGet(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<Array<ChargeV1Dto>>;
    public v1ChargesGetMarketParticipantsAsyncGet(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<Array<ChargeV1Dto>>>;
    public v1ChargesGetMarketParticipantsAsyncGet(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<Array<ChargeV1Dto>>>;
    public v1ChargesGetMarketParticipantsAsyncGet(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<ChargeV1Dto>>(`${this.configuration.basePath}/v1/Charges/GetMarketParticipantsAsync`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
