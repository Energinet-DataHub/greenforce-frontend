...
// @ts-ignore
import { ChargeMessageV1Dto } from '../model/charge-message-v1-dto';
// @ts-ignore
...
export class ChargesHttp {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v1ChargesSearchChargeMessagesAsyncPost(chargeMessagesSearchCriteriaV1Dto?: ChargeMessagesSearchCriteriaV1Dto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<Array<ChargeMessageV1Dto>>;
    public v1ChargesSearchChargeMessagesAsyncPost(chargeMessagesSearchCriteriaV1Dto?: ChargeMessagesSearchCriteriaV1Dto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<Array<ChargeMessageV1Dto>>>;
    public v1ChargesSearchChargeMessagesAsyncPost(chargeMessagesSearchCriteriaV1Dto?: ChargeMessagesSearchCriteriaV1Dto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<Array<ChargeMessageV1Dto>>>;
    public v1ChargesSearchChargeMessagesAsyncPost(chargeMessagesSearchCriteriaV1Dto?: ChargeMessagesSearchCriteriaV1Dto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<Array<ChargeMessageV1Dto>>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
