...
export const APIS = [EsettExchangeHttp, ImbalancePricesHttp, MarketParticipantActorHttp, MarketParticipantPermissionsHttp, MarketParticipantUserHttp, MessageArchiveHttp, TokenHttp, WholesaleSettlementReportHttp];
