...
export const APIS = [EsettExchangeHttp, ImbalancePricesHttp, MarketParticipantHttp, MarketParticipantActorHttp, MarketParticipantActorQueryHttp, MarketParticipantPermissionsHttp, MarketParticipantUserHttp, MarketParticipantUserOverviewHttp, MarketParticipantUserRoleHttp, MarketParticipantUserRoleAssignmentHttp, MessageArchiveHttp, TokenHttp, WholesaleSettlementReportHttp];
