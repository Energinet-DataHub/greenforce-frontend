...
export * from './request-aggregated-measure-data-http.service';
import { RequestAggregatedMeasureDataHttp } from './request-aggregated-measure-data-http.service';
...
export const APIS = [ChargeLinksHttp, ChargesHttp, EsettExchangeHttp, MarketParticipantHttp, MarketParticipantActorQueryHttp, MarketParticipantGridAreaHttp, MarketParticipantGridAreaOverviewHttp, MarketParticipantPermissionsHttp, MarketParticipantUserHttp, MarketParticipantUserOverviewHttp, MarketParticipantUserRoleHttp, MarketParticipantUserRoleAssignmentHttp, MessageArchiveHttp, MeteringPointHttp, RequestAggregatedMeasureDataHttp, TokenHttp, WholesaleSettlementReportHttp];
