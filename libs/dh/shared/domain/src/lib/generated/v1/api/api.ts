...
export const APIS = [EsettExchangeHttp, GraphQLHttp, ImbalancePricesHttp, MarketParticipantActorHttp, MarketParticipantPermissionsHttp, MarketParticipantUserHttp, MessageArchiveHttp, TokenHttp, WholesaleSettlementReportHttp];
