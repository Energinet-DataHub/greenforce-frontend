...
export const APIS = [EsettExchangeHttp, ImbalancePricesHttp, MarketParticipantHttp, MarketParticipantActorHttp, MarketParticipantActorQueryHttp, MarketParticipantPermissionsHttp, MarketParticipantUserHttp, MarketParticipantUserRoleHttp, MessageArchiveHttp, TokenHttp, WholesaleSettlementReportHttp];
