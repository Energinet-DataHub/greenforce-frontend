...
export const APIS = [EsettExchangeHttp, ImbalancePricesHttp, MarketParticipantHttp, MarketParticipantActorHttp, MarketParticipantActorQueryHttp, MarketParticipantPermissionsHttp, MarketParticipantUserHttp, MarketParticipantUserRoleHttp, MarketParticipantUserRoleAssignmentHttp, MessageArchiveHttp, TokenHttp, WholesaleSettlementReportHttp];
