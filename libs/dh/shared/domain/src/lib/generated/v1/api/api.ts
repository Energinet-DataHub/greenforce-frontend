...
export const APIS = [EsettExchangeHttp, ImbalancePricesHttp, MarketParticipantActorHttp, MarketParticipantActorQueryHttp, MarketParticipantPermissionsHttp, MarketParticipantUserHttp, MarketParticipantUserRoleHttp, MessageArchiveHttp, TokenHttp, WholesaleSettlementReportHttp];
