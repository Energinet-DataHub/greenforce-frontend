...
export const APIS = [ChargeLinksHttp, ChargesHttp, MarketParticipantHttp, MarketParticipantGridAreaHttp, MarketParticipantGridAreaOverviewHttp, MarketParticipantUserHttp, MarketParticipantUserOverviewHttp, MarketParticipantUserRoleTemplateHttp, MessageArchiveHttp, MeteringPointHttp, TokenHttp, WholesaleBatchHttp];
