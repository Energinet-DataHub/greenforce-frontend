...
export class WholesaleBatchHttp {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v1WholesaleBatchZippedBasisDataUrlPost(batchId?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<Stream>;
    public v1WholesaleBatchZippedBasisDataUrlPost(batchId?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<Stream>>;
    public v1WholesaleBatchZippedBasisDataUrlPost(batchId?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<Stream>>;
