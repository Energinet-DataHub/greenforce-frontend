...
export class WholesaleBatchHttp {
     ...
     */
    public v1WholesaleBatchGet(wholesaleSearchBatchDto?: WholesaleSearchBatchDto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<Array<WholesaleSearchBatchResponseDto>>;
    public v1WholesaleBatchGet(wholesaleSearchBatchDto?: WholesaleSearchBatchDto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<Array<WholesaleSearchBatchResponseDto>>>;
    public v1WholesaleBatchGet(wholesaleSearchBatchDto?: WholesaleSearchBatchDto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<Array<WholesaleSearchBatchResponseDto>>>;
    public v1WholesaleBatchGet(wholesaleSearchBatchDto?: WholesaleSearchBatchDto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<WholesaleSearchBatchResponseDto>>(`${this.configuration.basePath}/v1/WholesaleBatch`,
            {
