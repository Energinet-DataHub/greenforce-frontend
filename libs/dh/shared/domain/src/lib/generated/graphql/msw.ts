 ...
 *   ({ query, variables }) => {
 *     const { subject, meteringPointIdentification, internalNote, content, anonymous, receiver, energySupplierDate } = variables;
 *     return HttpResponse.json({
 ...
 *   ({ query, variables }) => {
 *     const { meteringPointIdentification, searchTerm } = variables;
 *     return HttpResponse.json({
 ...
 *   ({ query, variables }) => {
 *     const { conversationId, content, anonymous } = variables;
 *     return HttpResponse.json({
 ...
 *   ({ query, variables }) => {
 *     const { conversationId, internalNote } = variables;
 *     return HttpResponse.json({
 *       data: { updateInternalConversationNote }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockUpdateInternalConversationNoteMutation = (resolver: GraphQLResponseResolver<Types.UpdateInternalConversationNoteMutation, Types.UpdateInternalConversationNoteMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.UpdateInternalConversationNoteMutation, Types.UpdateInternalConversationNoteMutationVariables>(
 ...
 *     const { id } = variables;
 *     return HttpResponse.json({
 *       data: { operationToolsMeteringPoint }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockGetOperationToolsMeteringPointQuery = (resolver: GraphQLResponseResolver<Types.GetOperationToolsMeteringPointQuery, Types.GetOperationToolsMeteringPointQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.GetOperationToolsMeteringPointQuery, Types.GetOperationToolsMeteringPointQueryVariables>(
