...
export type Conversation = {
  ...
  wasLatestMessageAnonymous: Scalars['Boolean']['output'];
...
export type ConversationMessage = {
  ...
  isSentByCurrentActor: Scalars['Boolean']['output'];
...
export type ElectricalHeatingMessage = {
  __typename: 'ElectricalHeatingMessage';
  customerName?: Maybe<Scalars['String']['output']>;
  isElectricalHeatingActive: Scalars['Boolean']['output'];
  electricalHeatingFrom?: Maybe<Scalars['DateTime']['output']>;
  supplierPeriods: Array<ElectricityHeatingMessagePeriod>;
};

export type ElectricityHeatingMessagePeriod = {
...
export type GetMeteringPointDebugResultDtoV1 = {
  ...
  meteringPointWithRelationsJson?: Maybe<Scalars['String']['output']>;
...
export type Query = {
  ...
  operationToolsMeteringPoint?: Maybe<GetMeteringPointDebugResultDtoV1>;
...
export type QueryOperationToolsMeteringPointArgs = {
  id: Scalars['String']['input'];
};
...
export type StartConversationInput = {
  ...
  anonymous: Scalars['Boolean']['input'];
  receiver: ActorType;
  energySupplierDate?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export const MessageType = {
  ...
  ElectricalHeatingInformation: 'ELECTRICAL_HEATING_INFORMATION',
  ElectricalHeatingUserMessage: 'ELECTRICAL_HEATING_USER_MESSAGE'
} as const;
...
export type GetConversationQuery = { __typename: 'Query', conversation: { __typename: 'Conversation', id: string, displayId?: string | null, internalNote?: string | null, subject: ConversationSubject, closed: boolean, wasLatestMessageAnonymous: boolean, messages: Array<{ __typename: 'ConversationMessage', senderType: ActorType, messageType: MessageType, createdTime: Date, actorName?: string | null, userName: string, isSentByCurrentActor: boolean, anonymous: boolean, userMessage?: { __typename: 'UserMessage', content: string } | null }> } };
...
export type UpdateInternalConversationNoteMutationVariables = Exact<{
  conversationId: Scalars['UUID']['input'];
  internalNote: Scalars['String']['input'];
}>;


export type UpdateInternalConversationNoteMutation = { __typename: 'Mutation', updateInternalConversationNote: { __typename: 'UpdateInternalConversationNotePayload', boolean?: boolean | null } };
...
export type GetOperationToolsMeteringPointQueryVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type GetOperationToolsMeteringPointQuery = { __typename: 'Query', operationToolsMeteringPoint?: { __typename: 'GetMeteringPointDebugResultDtoV1', meteringPointJson: string, meteringPointWithRelationsJson?: string | null, events: Array<{ __typename: 'ElectricityMarketV2EventDto', id: string, timestamp: Date, type: string, dataJson: string }> } | null };
...
export type CustomerContactFragment = { __typename: 'ElectricityMarketViewCustomerContactDto', id: string, phone?: string | null, email?: string | null, streetName?: string | null, buildingNumber?: string | null, postCode?: string | null, streetCode?: string | null, cityName?: string | null, municipalityCode?: string | null, postBox?: string | null, countryCode?: string | null, darReference?: string | null, attention?: string | null, isProtectedAddress: boolean, citySubDivisionName?: string | null, name?: string | null, mobile?: string | null, floor?: string | null, room?: string | null };
...
export type GetMeteringPointProcessByIdQuery = { __typename: 'Query', meteringPointProcessById?: { __typename: 'MeteringPointProcess', id: string, createdAt: Date, cutoffDate?: Date | null, reasonCode: string, state: ProcessState, steps: Array<{ __typename: 'MeteringPointProcessStep', id: string, step: string, comment?: string | null, description: string, completedAt?: Date | null, dueDate?: Date | null, state: ProcessState, documentUrl?: string | null, actor?: { __typename: 'MarketParticipant', id: string, name: string } | null }>, initiator?: { __typename: 'MarketParticipant', id: string, displayName: string } | null } | null };
...
export const StartConversationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"StartConversation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"subject"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ConversationSubject"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"meteringPointIdentification"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"internalNote"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"content"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"anonymous"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"receiver"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ActorType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"energySupplierDate"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startConversation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"startConversationInput"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"subject"},"value":{"kind":"Variable","name":{"kind":"Name","value":"subject"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"meteringPointIdentification"},"value":{"kind":"Variable","name":{"kind":"Name","value":"meteringPointIdentification"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"internalNote"},"value":{"kind":"Variable","name":{"kind":"Name","value":"internalNote"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"content"},"value":{"kind":"Variable","name":{"kind":"Name","value":"content"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"anonymous"},"value":{"kind":"Variable","name":{"kind":"Name","value":"anonymous"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"receiver"},"value":{"kind":"Variable","name":{"kind":"Name","value":"receiver"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"energySupplierDate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"energySupplierDate"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"string"}}]}}]}}]} as unknown as DocumentNode<StartConversationMutation, StartConversationMutationVariables>;
...
export const SendActorConversationMessageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SendActorConversationMessage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"content"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"anonymous"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sendActorConversationMessage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"sendActorConversationMessageInput"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"conversationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"anonymous"},"value":{"kind":"Variable","name":{"kind":"Name","value":"anonymous"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"content"},"value":{"kind":"Variable","name":{"kind":"Name","value":"content"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"boolean"}}]}}]}}]} as unknown as DocumentNode<SendActorConversationMessageMutation, SendActorConversationMessageMutationVariables>;
...
export const UpdateInternalConversationNoteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateInternalConversationNote"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"internalNote"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateInternalConversationNote"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"updateInternalConversationNoteInput"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"conversationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"internalNote"},"value":{"kind":"Variable","name":{"kind":"Name","value":"internalNote"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"boolean"}}]}}]}}]} as unknown as DocumentNode<UpdateInternalConversationNoteMutation, UpdateInternalConversationNoteMutationVariables>;
...
export const GetOperationToolsMeteringPointDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOperationToolsMeteringPoint"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operationToolsMeteringPoint"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"meteringPointJson"}},{"kind":"Field","name":{"kind":"Name","value":"meteringPointWithRelationsJson"}},{"kind":"Field","name":{"kind":"Name","value":"events"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"dataJson"}}]}}]}}]}}]} as unknown as DocumentNode<GetOperationToolsMeteringPointQuery, GetOperationToolsMeteringPointQueryVariables>;
...
export const scalarTypePolicies = {
  ...
  ElectricalHeatingMessage: { fields: { electricalHeatingFrom: dateTypePolicy } },
  ElectricityHeatingMessagePeriod: { fields: { from: dateTypePolicy, to: dateTypePolicy } },
