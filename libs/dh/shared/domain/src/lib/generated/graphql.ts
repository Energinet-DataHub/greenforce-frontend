...
export type Query = {
  ...
  createDelegationsForActor: CreateDelegationResponse;
};
...
export type QueryCreateDelegationsForActorArgs = {
  actorId: Scalars['UUID']['input'];
  delegationDto: CreateDelegationDtoInput;
};
...
export type CreateDelegationDtoInput = {
...
export type ActorDelegation = {
  __typename: 'ActorDelegation';
  delegatedBy: ActorId;
  delegatedTo: ActorId;
...
export type GetGetDelegationsForActorAsyncQueryVariables = Exact<{ [key: string]: never; }>;


export type GetGetDelegationsForActorAsyncQuery = { __typename: 'Query', esettExchangeStatusReport: { __typename: 'ExchangeEventStatusReportResponse', waitingForExternalResponse: number } };
...
export const GetGetDelegationsForActorAsyncDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetGetDelegationsForActorAsync"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"esettExchangeStatusReport"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"waitingForExternalResponse"}}]}}]}}]} as unknown as DocumentNode<GetGetDelegationsForActorAsyncQuery, GetGetDelegationsForActorAsyncQueryVariables>;
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockGetGetDelegationsForActorAsyncQuery((req, res, ctx) => {
 *   return res(
 *     ctx.data({ esettExchangeStatusReport })
 *   )
 * })
 */
export const mockGetGetDelegationsForActorAsyncQuery = (resolver: Parameters<typeof graphql.query<GetGetDelegationsForActorAsyncQuery, GetGetDelegationsForActorAsyncQueryVariables>>[1]) =>
  graphql.query<GetGetDelegationsForActorAsyncQuery, GetGetDelegationsForActorAsyncQueryVariables>(
    'GetGetDelegationsForActorAsync',
    resolver
  )
...
export const scalarTypePolicies = {
  ...
  ActorDelegation: { fields: { createdAt: dateTypePolicy, expiresAt: dateTypePolicy } },
};
