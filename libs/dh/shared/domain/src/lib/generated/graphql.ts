...
export type MessageDelegationType = {
  ...
  id: MessageDelegationId;
  periodId: DelegationPeriodId;
...
export type MessageDelegationId = {
  __typename: 'MessageDelegationId';
  value: Scalars['UUID']['output'];
};

export type DelegationPeriodId = {
  __typename: 'DelegationPeriodId';
  value: Scalars['UUID']['output'];
};
...
export type StopMessageDelegationDtoInput = {
  id: MessageDelegationIdInput;
  periodId: DelegationPeriodIdInput;
  stopsAt?: InputMaybe<Scalars['DateTime']['input']>;
};

export type CreateMessageDelegationInput = {
  delegatedBy: Scalars['UUID']['input'];
...
export type DelegationPeriodIdInput = {
  value: Scalars['UUID']['input'];
};

export type MessageDelegationIdInput = {
  value: Scalars['UUID']['input'];
};
...
export type CreateDelegationsForActorInput = {
  actorId: Scalars['UUID']['input'];
  delegationDto: CreateMessageDelegationInput;
};
...
export type GetActorByIdQuery = { __typename: 'Query', actorById: { __typename: 'Actor', id: any, glnOrEicNumber: string, name: string, marketRole?: EicFunction | null, status: ActorStatus, gridAreas: Array<{ __typename: 'GridAreaDto', code: string, name: string, id: any }>, organization: { __typename: 'Organization', name: string } } };
...
export type GetDelegationsForActorQuery = { __typename: 'Query', getDelegationsForActor: Array<{ __typename: 'MessageDelegationType', messageType: DelegationMessageType, startsAt: Date, expiresAt?: Date | null, status: ActorDelegationStatus, periodId: { __typename: 'DelegationPeriodId', value: any }, id: { __typename: 'MessageDelegationId', value: any }, delegatedBy?: { __typename: 'Actor', id: any, name: string } | null, delegatedTo?: { __typename: 'Actor', id: any, name: string } | null, gridArea?: { __typename: 'GridAreaDto', id: any, code: string } | null }> };

export type GetDelegatesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDelegatesQuery = { __typename: 'Query', actorsForEicFunction: Array<{ __typename: 'Actor', name: string, id: any }> };
...
export type GetGridAreasQuery = { __typename: 'Query', gridAreas: Array<{ __typename: 'GridAreaDto', id: any, code: string, name: string, validTo?: Date | null, validFrom: Date }> };
