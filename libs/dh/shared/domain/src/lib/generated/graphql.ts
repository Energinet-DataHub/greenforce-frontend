...
export type ImbalancePriceDaily = {
  ...
  status: ImbalancePricePeriodStatus;
  timeStamp: Scalars['DateTime']['output'];
...
export enum ImbalancePricePeriodStatus {
  NoPrices = 'NO_PRICES',
...
export type GetImbalancePricesMonthOverviewQuery = { __typename: 'Query', imbalancePricesForMonth: Array<{ __typename: 'ImbalancePriceDaily', status: ImbalancePricePeriodStatus, timeStamp: Date, imbalancePrices: Array<{ __typename: 'ImbalancePrice', timestamp: Date, price: number }> }> };
