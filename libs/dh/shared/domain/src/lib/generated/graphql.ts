...
export type ImbalancePriceDaily = {
  ...
  status: ImbalancePriceDailyCompletenessStatus;
  timeStamp: Scalars['DateTime']['output'];
...
export enum ImbalancePriceDailyCompletenessStatus {
  NoData = 'NO_DATA',
...
export type GetImbalancePriceByMonthAndYearQueryVariables = Exact<{
  month: Scalars['Int']['input'];
  year: Scalars['Int']['input'];
  areaCode: PriceAreaCode;
}>;
...
export type GetImbalancePriceByMonthAndYearQuery = { __typename: 'Query', imbalancePricesForMonth: Array<{ __typename: 'ImbalancePriceDaily', imbalancePrices: Array<{ __typename: 'ImbalancePrice', price: number, timestamp: Date, priceAreaCode: PriceAreaCode }> }> };
...
export const GetImbalancePriceByMonthAndYearDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetImbalancePriceByMonthAndYear"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"month"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"year"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"areaCode"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PriceAreaCode"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"imbalancePricesForMonth"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"month"},"value":{"kind":"Variable","name":{"kind":"Name","value":"month"}}},{"kind":"Argument","name":{"kind":"Name","value":"year"},"value":{"kind":"Variable","name":{"kind":"Name","value":"year"}}},{"kind":"Argument","name":{"kind":"Name","value":"areaCode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"areaCode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"imbalancePrices"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"priceAreaCode"}}]}}]}}]}}]} as unknown as DocumentNode<GetImbalancePriceByMonthAndYearQuery, GetImbalancePriceByMonthAndYearQueryVariables>;
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockGetImbalancePriceByMonthAndYearQuery((req, res, ctx) => {
 *   const { month, year, areaCode } = req.variables;
 *   return res(
 *     ctx.data({ imbalancePricesForMonth })
 *   )
 * })
 */
export const mockGetImbalancePriceByMonthAndYearQuery = (resolver: Parameters<typeof graphql.query<GetImbalancePriceByMonthAndYearQuery, GetImbalancePriceByMonthAndYearQueryVariables>>[1]) =>
  graphql.query<GetImbalancePriceByMonthAndYearQuery, GetImbalancePriceByMonthAndYearQueryVariables>(
    'GetImbalancePriceByMonthAndYear',
    resolver
  )
...
export const scalarTypePolicies = {
  ...
  ImbalancePriceDaily: { fields: { timeStamp: dateTypePolicy } },
