...
export type GetOrganizationsQuery = { __typename: 'Query', organizations: Array<{ __typename: 'OrganizationDto', organizationId: any, businessRegisterIdentifier: string, name: string, status: OrganizationStatus }> };
