...
export type GetActorEditableFieldsQuery = { __typename: 'Query', actorById: { __typename: 'Actor', name: string, organization: { __typename: 'OrganizationDto', domain: string }, contact?: { __typename: 'ActorContactDto', contactId: any, name: string, email: string, phone?: string | null } | null } };
...
export type UpdateActorMutation = { __typename: 'Mutation', updateActor: { __typename: 'UpdateActorPayload', actor?: { __typename: 'Actor', id: any } | null } };
...
export type GetOrganizationsQuery = { __typename: 'Query', organizations: Array<{ __typename: 'OrganizationDto', organizationId: any, name: string, status: OrganizationStatus }> };
