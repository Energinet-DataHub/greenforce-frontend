...
export enum TimeSeriesType {
  ...
  NetExchangePerGridArea = 'NET_EXCHANGE_PER_GRID_AREA',
 ...
 *   const { executionTime, period, processTypes, gridAreaCodes } = req.variables;
 *   return res(
 *     ctx.data({ batches })
 *   )
 * })
