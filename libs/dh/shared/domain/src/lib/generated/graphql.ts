...
export type Query = {
  ...
  createDelegationsForActor: CreateActorDelegationResponse;
};
...
export type QueryCreateDelegationsForActorArgs = {
  actorId: Scalars['UUID']['input'];
...
export type CreateActorDelegationResponse = {
  __typename: 'CreateActorDelegationResponse';
  delegation: ActorDelegationDto;
};

export type GetDelegationsForActorResponse = {
  __typename: 'GetDelegationsForActorResponse';
  delegations: Array<ActorDelegationDto>;
};
...
export type ActorDelegationDto = {
  __typename: 'ActorDelegationDto';
  id: ActorDelegationId;
  delegatedBy: ActorId;
  delegatedTo: ActorId;
  gridAreas: Array<GridAreaCode>;
  messageType: DelegationMessageType;
...
export type GetDelegationsForActorQuery = { __typename: 'Query', getDelegationsForActor: { __typename: 'GetDelegationsForActorResponse', delegations: Array<{ __typename: 'ActorDelegationDto', messageType: DelegationMessageType, createdAt: Date, expiresAt?: Date | null, delegatedTo: { __typename: 'ActorId', value: any }, gridAreas: Array<{ __typename: 'GridAreaCode', value: string }> }> } };
...
export const scalarTypePolicies = {
  ...
  ActorDelegationDto: { fields: { createdAt: dateTypePolicy, expiresAt: dateTypePolicy } },
};
