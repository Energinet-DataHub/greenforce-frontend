...
export type Batch = {
  __typename?: 'Batch';
  /** Id of the user who started the batch. */
...
export type GetActorsForSettlementReportQueryVariables = Exact<{
  eicFunctions: Array<EicFunction> | EicFunction;
}>;
