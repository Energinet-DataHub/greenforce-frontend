...
export type Calculation = {
  ...
  executionTimeStart: Scalars['DateTime']['output'];
...
export type Query = {
  ...
  /** @deprecated Use `latestCalculation` instead */
...
export type SettlementReport = {
  ...
  fromApi: Scalars['Boolean']['output'];
...
export type CalculationSortInput = {
  ...
  isInternalCalculation?: InputMaybe<SortEnumType>;
...
export type CancelScheduledCalculationInput = {
  calculationId: Scalars['UUID']['input'];
};
...
export enum BalanceResponsibilityMeteringPointType {
...
export enum CalculationExecutionType {
  External = 'EXTERNAL',
  Internal = 'INTERNAL'
}
...
export enum EsettTimeSeriesType {
  MgaExchange = 'MgaExchange',
  Production = 'Production',
  Consumption = 'Consumption'
}
...
export enum RequestCalculationDataType {
...
export type GetFilteredActorsQuery = { __typename: 'Query', filteredActors: Array<{ __typename: 'Actor', displayName: string, id: string, organization: { __typename: 'Organization', id: string, domain: string } }> };
...
export type GetAllUsersQuery = { __typename: 'Query', userOverviewSearch: { __typename: 'GetUserOverviewResponse', users: Array<{ __typename: 'User', id: string, name: string, email: string, administratedBy?: { __typename: 'Actor', id: string, name: string, organization: { __typename: 'Organization', id: string, name: string } } | null }> } };
...
export type GetUserByIdQuery = { __typename: 'Query', userById: { __typename: 'User', id: string, email: string, phoneNumber?: string | null, status: UserStatus, createdDate: Date, firstName: string, lastName: string, administratedBy?: { __typename: 'Actor', id: string } | null, actors: Array<{ __typename: 'Actor', id: string, name: string, glnOrEicNumber: string, organization: { __typename: 'Organization', id: string, name: string }, userRoles: Array<{ __typename: 'ActorUserRole', id: string, eicFunction: EicFunction, name: string, description: string, assigned: boolean }> }> } };
...
export type GetBalanceResponsibleMessagesQuery = { __typename: 'Query', balanceResponsible: { __typename: 'BalanceResponsiblePageResult', balanceResponsiblesUrl?: string | null, totalCount: number, page: Array<{ __typename: 'BalanceResponsibleType', id: string, receivedDateTime: Date, supplier: string, storageDocumentUrl?: string | null, balanceResponsible: string, meteringPointType: BalanceResponsibilityMeteringPointType, validPeriod: { start: Date, end: Date | null }, gridArea: string, supplierWithName?: { __typename: 'ActorNameDto', value: string } | null, balanceResponsibleWithName?: { __typename: 'ActorNameDto', value: string } | null, gridAreaWithName?: { __typename: 'GridAreaDto', id: string, code: string, name: string } | null }> } };
...
export type UserProfileQuery = { __typename: 'Query', userProfile: { __typename: 'GetUserProfileResponse', firstName: string, lastName: string, phoneNumber: string, hasFederatedLogin: boolean } };
...
export type GetCalculationsQuery = { __typename: 'Query', calculations?: { __typename: 'CalculationsConnection', totalCount: number, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, nodes?: Array<{ __typename: 'Calculation', id: string, state: CalculationOrchestrationState, executionTimeStart: Date, executionTimeEnd?: Date | null, period: { start: Date, end: Date | null }, statusType: ProcessStatus, executionType: CalculationExecutionType, calculationType: CalculationType, createdByUserName?: string | null, currentStep: CalculationProgressStep, gridAreas: Array<{ __typename: 'GridAreaDto', id: string, code: string, displayName: string }>, progress: Array<{ __typename: 'CalculationProgress', step: CalculationProgressStep, status: ProgressStatus }> }> | null } | null };
...
export type GetSettlementReportCalculationsByGridAreasQuery = { __typename: 'Query', settlementReportGridAreaCalculationsForPeriod: Array<{ __typename: 'KeyValuePairOfStringAndListOfRequestSettlementReportGridAreaCalculation', key: string, value: Array<{ __typename: 'RequestSettlementReportGridAreaCalculation', calculationId: string, calculationDate: Date, gridAreaWithName?: { __typename: 'GridAreaDto', id: string, displayName: string, code: string } | null }> }> };
...
export type GetLatestCalculationQuery = { __typename: 'Query', latestCalculation?: { __typename: 'Calculation', id: string, period: { start: Date, end: Date | null } } | null };
...
export type GetActorsForRequestCalculationQuery = { __typename: 'Query', actorsForEicFunction: Array<{ __typename: 'Actor', id: string, marketRole?: EicFunction | null, value: string, displayValue: string }> };

export type GetSelectedActorQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSelectedActorQuery = { __typename: 'Query', selectedActor: { __typename: 'Actor', id: string, glnOrEicNumber: string, marketRole?: EicFunction | null, gridAreas: Array<{ __typename: 'GridAreaDto', id: string, code: string, name: string }> } };
...
export type GetSettlementReportsQuery = { __typename: 'Query', settlementReports: Array<{ __typename: 'SettlementReport', id: string, calculationType: CalculationType, period: { start: Date, end: Date | null }, numberOfGridAreasInReport: number, includesBasisData: boolean, progress: number, statusType: SettlementReportStatusType, settlementReportDownloadUrl?: string | null, executionTime: { start: Date, end: Date | null }, fromApi: boolean, combineResultInASingleFile: boolean, includeMonthlyAmount: boolean, gridAreas: Array<string>, actor?: { __typename: 'Actor', id: string, name: string } | null }> };

export type OnCalculationUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type OnCalculationUpdatedSubscription = { __typename: 'Subscription', calculationUpdated: { __typename: 'Calculation', id: string, state: CalculationOrchestrationState, executionTimeEnd?: Date | null, executionTimeStart: Date, period: { start: Date, end: Date | null }, statusType: ProcessStatus, executionType: CalculationExecutionType, calculationType: CalculationType, createdByUserName?: string | null, currentStep: CalculationProgressStep, gridAreas: Array<{ __typename: 'GridAreaDto', id: string, code: string, displayName: string }>, progress: Array<{ __typename: 'CalculationProgress', step: CalculationProgressStep, status: ProgressStatus }> } };
...
export type GetActorEditableFieldsQuery = { __typename: 'Query', actorById: { __typename: 'Actor', id: string, name: string, organization: { __typename: 'Organization', domain: string, id: string }, contact?: { __typename: 'ActorContactDto', name: string, email: string, phone?: string | null } | null } };
...
export type GetOrganizationByIdQuery = { __typename: 'Query', organizationById: { __typename: 'Organization', id: string, name: string, businessRegisterIdentifier: string, domain: string, address: { __typename: 'AddressDto', country: string } } };
...
export type GetGridAreasQuery = { __typename: 'Query', gridAreas: Array<{ __typename: 'GridAreaDto', id: string, code: string, name: string, displayName: string, validTo?: Date | null, validFrom: Date, includedInCalculation: boolean }> };
...
export type GetActorByIdQuery = { __typename: 'Query', actorById: { __typename: 'Actor', id: string, glnOrEicNumber: string, name: string, marketRole?: EicFunction | null, status: ActorStatus, gridAreas: Array<{ __typename: 'GridAreaDto', code: string, name: string, displayName: string, id: string }>, organization: { __typename: 'Organization', name: string, id: string } } };
...
export const GetAllUsersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAllUsers"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"actorId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userStatus"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserStatus"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userRoleIds"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pageNumber"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sortDirection"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MarketParticipantSortDirctionType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sortProperty"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserOverviewSortProperty"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userOverviewSearch"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"actorId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"actorId"}}},{"kind":"Argument","name":{"kind":"Name","value":"userRoleIds"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userRoleIds"}}},{"kind":"Argument","name":{"kind":"Name","value":"userStatus"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userStatus"}}},{"kind":"Argument","name":{"kind":"Name","value":"pageSize"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}}},{"kind":"Argument","name":{"kind":"Name","value":"pageNumber"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pageNumber"}}},{"kind":"Argument","name":{"kind":"Name","value":"sortProperty"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sortProperty"}}},{"kind":"Argument","name":{"kind":"Name","value":"sortDirection"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sortDirection"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"users"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"administratedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"organization"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetAllUsersQuery, GetAllUsersQueryVariables>;
...
export const GetOutgoingMessagesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getOutgoingMessages"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pageNumber"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodInterval"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateRange"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sentInterval"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateRange"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gridAreaCodes"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"createdInterval"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateRange"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"calculationType"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ExchangeEventCalculationType"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"documentStatuses"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DocumentStatus"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"timeSeriesType"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"EsettTimeSeriesType"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"documentId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sortProperty"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ExchangeEventSortProperty"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sortDirection"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SortDirection"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"actorNumber"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"esettExchangeEvents"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"pageNumber"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pageNumber"}}},{"kind":"Argument","name":{"kind":"Name","value":"pageSize"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}}},{"kind":"Argument","name":{"kind":"Name","value":"periodInterval"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodInterval"}}},{"kind":"Argument","name":{"kind":"Name","value":"gridAreaCodes"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gridAreaCodes"}}},{"kind":"Argument","name":{"kind":"Name","value":"calculationType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"calculationType"}}},{"kind":"Argument","name":{"kind":"Name","value":"documentStatuses"},"value":{"kind":"Variable","name":{"kind":"Name","value":"documentStatuses"}}},{"kind":"Argument","name":{"kind":"Name","value":"timeSeriesType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"timeSeriesType"}}},{"kind":"Argument","name":{"kind":"Name","value":"documentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"documentId"}}},{"kind":"Argument","name":{"kind":"Name","value":"sortProperty"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sortProperty"}}},{"kind":"Argument","name":{"kind":"Name","value":"sortDirection"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sortDirection"}}},{"kind":"Argument","name":{"kind":"Name","value":"createdInterval"},"value":{"kind":"Variable","name":{"kind":"Name","value":"createdInterval"}}},{"kind":"Argument","name":{"kind":"Name","value":"sentInterval"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sentInterval"}}},{"kind":"Argument","name":{"kind":"Name","value":"actorNumber"},"value":{"kind":"Variable","name":{"kind":"Name","value":"actorNumber"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"created"}},{"kind":"Field","name":{"kind":"Name","value":"lastDispatched"}},{"kind":"Field","name":{"kind":"Name","value":"documentId"}},{"kind":"Field","name":{"kind":"Name","value":"actorNumber"}},{"kind":"Field","name":{"kind":"Name","value":"energySupplier"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"calculationType"}},{"kind":"Field","name":{"kind":"Name","value":"timeSeriesType"}},{"kind":"Field","name":{"kind":"Name","value":"gridArea"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"gridAreaCodeOut"}},{"kind":"Field","name":{"kind":"Name","value":"documentStatus"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalCount"}},{"kind":"Field","name":{"kind":"Name","value":"gridAreaCount"}}]}}]}}]} as unknown as DocumentNode<GetOutgoingMessagesQuery, GetOutgoingMessagesQueryVariables>;
...
export const RequestCalculationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"requestCalculation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"calculationType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CalculationType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"period"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateRange"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gridArea"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"requestCalculationDataType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RequestCalculationDataType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"balanceResponsibleId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"energySupplierId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestCalculation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"calculationType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"calculationType"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"period"},"value":{"kind":"Variable","name":{"kind":"Name","value":"period"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"gridArea"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gridArea"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"requestCalculationDataType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"requestCalculationDataType"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"balanceResponsibleId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"balanceResponsibleId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"energySupplierId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"energySupplierId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"success"},"name":{"kind":"Name","value":"boolean"}}]}}]}}]} as unknown as DocumentNode<RequestCalculationMutation, RequestCalculationMutationVariables>;
...
export const GetLatestCalculationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLatestCalculation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"period"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateRange"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"calculationType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CalculationType"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"latestCalculation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"period"},"value":{"kind":"Variable","name":{"kind":"Name","value":"period"}}},{"kind":"Argument","name":{"kind":"Name","value":"calculationType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"calculationType"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"period"}}]}}]}}]} as unknown as DocumentNode<GetLatestCalculationQuery, GetLatestCalculationQueryVariables>;
 ...
 *   ({ query, variables }) => {
 *     const { actorId, userStatus, userRoleIds, pageNumber, pageSize, sortDirection, sortProperty } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockGetAllUsersQuery = (resolver: GraphQLResponseResolver<GetAllUsersQuery, GetAllUsersQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<GetAllUsersQuery, GetAllUsersQueryVariables>(
    'GetAllUsers',
    resolver,
    options
  )
 ...
 *   ({ query, variables }) => {
 *     const { pageNumber, pageSize, createdFrom, createdTo, calculationPeriod, gridAreaCodes, documentId, valuesToInclude, sortProperty, sortDirection } = variables;
 *     return HttpResponse.json({
 ...
 *   ({ query, variables }) => {
 *     const { locale, periodInterval, createdInterval, sentInterval, gridAreaCodes, calculationType, timeSeriesType, documentStatuses, documentId, sortProperty, sortDirection, actorNumber } = variables;
 *     return HttpResponse.json({
 ...
 *   ({ query, variables }) => {
 *     const { locale, createdFrom, createdTo, calculationPeriod, gridAreaCodes, documentId, valuesToInclude, sortProperty, sortDirection } = variables;
 *     return HttpResponse.json({
 ...
 *   ({ query, variables }) => {
 *     const { pageNumber, pageSize, periodInterval, sentInterval, gridAreaCodes, createdInterval, calculationType, documentStatuses, timeSeriesType, documentId, sortProperty, sortDirection, actorNumber } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockAddTokenToDownloadUrlMutation = (resolver: GraphQLResponseResolver<AddTokenToDownloadUrlMutation, AddTokenToDownloadUrlMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<AddTokenToDownloadUrlMutation, AddTokenToDownloadUrlMutationVariables>(
 ...
 *   ({ query, variables }) => {
 *     const { calculationType, period, gridArea, requestCalculationDataType, balanceResponsibleId, energySupplierId } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockCancelScheduledCalculationMutation = (resolver: GraphQLResponseResolver<CancelScheduledCalculationMutation, CancelScheduledCalculationMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<CancelScheduledCalculationMutation, CancelScheduledCalculationMutationVariables>(
 ...
 *   ({ query, variables }) => {
 *     const { period, calculationType } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockGetLatestCalculationQuery = (resolver: GraphQLResponseResolver<GetLatestCalculationQuery, GetLatestCalculationQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<GetLatestCalculationQuery, GetLatestCalculationQueryVariables>(
...
export class GetCalculationsDataSource extends ApolloDataSource<GetCalculationsQuery, GetCalculationsQueryVariables, NonNullable<NonNullable<GetCalculationsQuery['calculations']>['nodes']>[number]> { constructor(options?: QueryOptions<GetCalculationsQueryVariables>) { super(GetCalculationsDocument, data => data.calculations, options); } }