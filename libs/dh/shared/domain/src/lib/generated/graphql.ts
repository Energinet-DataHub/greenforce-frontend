...
export type ActorDelegationType = {
...
export type Query = {
  ...
  getDelegationsForActor: GetDelegationsForActorResponse;
};
...
export type ActorDelegationId = {
  __typename: 'ActorDelegationId';
...
export type CreateActorDelegationDtoInput = {
...
export type GetDelegationsForActorResponse = {
  __typename: 'GetDelegationsForActorResponse';
  delegations: Array<ActorDelegationType>;
};
...
export type CreateDelegationsForActorInput = {
  actorId: Scalars['UUID']['input'];
  delegationDto: CreateActorDelegationDtoInput;
};
...
export type GetDelegationsForActorQuery = { __typename: 'Query', getDelegationsForActor: { __typename: 'GetDelegationsForActorResponse', delegations: Array<{ __typename: 'ActorDelegationType', messageType: DelegationMessageType, startsAt: Date, expiresAt?: Date | null, status: ActorDelegationStatus, delegatedTo?: { __typename: 'Actor', id: any, name: string } | null, gridArea?: { __typename: 'GridAreaDto', id: any, code: string } | null }> } };
...
export const scalarTypePolicies = {
  ...
  ActorDelegationType: { fields: { startsAt: dateTypePolicy, expiresAt: dateTypePolicy } },
