 ...
 *   const { locale, createdFrom, createdTo, gridAreaCode, documentId, valuesToInclude, sortProperty, sortDirection } = req.variables;
 *   return res(
 ...
 *   const { pageNumber, pageSize, createdFrom, createdTo, gridAreaCode, documentId, valuesToInclude, sortProperty, sortDirection } = req.variables;
 *   return res(
