...
export type GetMeteringGridAreaImbalanceQuery = { __typename: 'Query', meteringGridAreaImbalance: { __typename: 'MeteringGridAreaImbalanceSearchResponse', totalCount: number, items: Array<{ __typename: 'MeteringGridAreaImbalanceSearchResult', id: string, documentDateTime: Date, receivedDateTime: Date, periodStart: Date, periodEnd: Date, gridArea?: { __typename: 'GridAreaDto', name: string, code: string } | null, imbalancePerDay: Array<{ __typename: 'MeteringGridAreaImbalancePerDayDto', imbalanceDay: Date, incomingQuantity?: number | null, outgoingQuantity?: number | null }> }> } };
