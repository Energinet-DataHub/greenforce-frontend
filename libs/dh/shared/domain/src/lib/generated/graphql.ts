...
export type GetLatestBatchQueryVariables = Exact<{
  period?: InputMaybe<Scalars['DateRange']>;
}>;


export type GetLatestBatchQuery = { __typename?: 'GraphQLQuery', batches: Array<{ __typename?: 'Batch', executionTimeStart?: string | null }> };
...
export const GetLatestBatchDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLatestBatch"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"period"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateRange"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"batches"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}},{"kind":"Argument","name":{"kind":"Name","value":"period"},"value":{"kind":"Variable","name":{"kind":"Name","value":"period"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"executionTimeStart"}}]}}]}}]} as unknown as DocumentNode<GetLatestBatchQuery, GetLatestBatchQueryVariables>;
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockGetLatestBatchQuery((req, res, ctx) => {
 ...
 * })
 */
export const mockGetLatestBatchQuery = (resolver: ResponseResolver<GraphQLRequest<GetLatestBatchQueryVariables>, GraphQLContext<GetLatestBatchQuery>, any>) =>
  graphql.query<GetLatestBatchQuery, GetLatestBatchQueryVariables>(
    'GetLatestBatch',
    resolver
  )
