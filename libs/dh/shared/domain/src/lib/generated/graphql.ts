 ...
 *   const { locale, periodInterval, createdInterval, sentInterval, gridAreaCode, calculationType, timeSeriesType, documentStatus, documentId, sortProperty, sortDirection, actorNumber } = req.variables;
 *   return res(
 ...
 *   const { pageNumber, pageSize, periodInterval, sentInterval, gridAreaCode, createdInterval, calculationType, documentStatus, timeSeriesType, documentId, sortProperty, sortDirection, actorNumber } = req.variables;
 *   return res(
