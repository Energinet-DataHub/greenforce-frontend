...
export type GetDelegationsForActorQuery = { __typename: 'Query', getDelegationsForActor: { __typename: 'GetDelegationsForActorResponse', delegations: Array<{ __typename: 'ActorDelegationType', messageType: DelegationMessageType, startsAt: Date, expiresAt?: Date | null, delegatedTo?: { __typename: 'Actor', id: any, name: string } | null, gridArea?: { __typename: 'GridAreaDto', id: any, code: string } | null }> } };
