...
export type Query = {
  ...
  balanceResponsiblesForActor: BalanceResponsibleActors;
...
export type QueryBalanceResponsiblesForActorArgs = {
  actorId: Scalars['UUID']['input'];
};
...
export type BalanceResponsibleActors = {
  __typename: 'BalanceResponsibleActors';
  actors: Array<BalanceResponsibleActor>;
};
 ...
 *   const { pageNumber, pageSize, periodInterval, gridAreaCode, createdInterval, calculationType, documentStatus, timeSeriesType, documentId, sortProperty, sortDirection, actorNumber } = req.variables;
 *   return res(
...
export const scalarTypePolicies = {
  ...
  BalanceResponsibleActor: { fields: { received: dateTypePolicy, validFrom: dateTypePolicy, validTo: dateTypePolicy } },
