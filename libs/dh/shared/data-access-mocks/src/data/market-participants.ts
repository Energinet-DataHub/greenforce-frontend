...
export const marketParticipants: MarketParticipant[] = [
  {
  ...
  },
  {
    ...
    marketRole: EicFunction.GridAccessProvider,
    status: MarketParticipantStatus.ToBeDiscontinued,
    organization: {
      __typename: 'Organization',
  ...
  },
  {
    ...
    status: MarketParticipantStatus.Discontinued,
    organization: {
      __typename: 'Organization',
  ...
  },
  {
    ...
    marketRole: EicFunction.BalanceResponsibleParty,
    status: null as unknown as MarketParticipantStatus,
    organization: {
      __typename: 'Organization',
