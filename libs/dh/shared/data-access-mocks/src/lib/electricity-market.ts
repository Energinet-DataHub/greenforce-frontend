...
const meteringPoints: MeteringPointPeriodDto[] = [
  {
    ...
    fromGridAreaCode: 'Area1',
    toGridAreaCode: 'Area2',
    meterNumber: '123456',
    meterReadingOccurrence: 'Monthly',
    capacity: '10kW',
    connectionType: 'Direct',
    netSettlementGroup: 'Group1',
    physicalStatus: 'Active',
    powerLimitA: '16A',
    powerPlantGsrn: 'GSRN123456',
    productCode: 'P123',
    productionObligation: 'None',
    scheduledMeterReading: 'Monthly',
    installationAddress: {
      __typename: 'InstallationAddressDto',
      buildingNumber: '1',
      cityName: 'Test City',
      citySubDivisionName: 'Test City',
      countryCode: 'DK',
      darReference: '12345678',
      floor: '1',
      id: '1',
        ...
        contacts: [
          {
            ...
            contact: {
              ...
              citySubDivisionName: 'Example Subdivision',
              countryCode: 'US',
              darReference: '87654321',
              floor: '2',
              id: '2',
              isProtectedAddress: false,
              municipalityCode: '321',
              postBox: '87654321',
              postCode: '4321',
              room: '2',
              streetCode: '321',
