...
const mockedCalculations: WholesaleAndEnergyCalculation[] = [
  ...
  },
  {
    ...
    terminatedAt,
    gridAreas: mockedGridAreas,
    calculationType: CalculationTypeQueryParameterV1.CapacitySettlement,
    createdBy: {
      __typename: 'AuditIdentityDto',
      auditIdentityId,
      displayName: fakeUserEmail,
    ...
    steps: [
      ...
      },
      {
        ...
        error: {
          ...
          code: 'FAILED_ENQUEUE_MEASUREMENTS',
          message: 'Failed to enqueue measurements for 9 metering points',
          meteringPointIds: [
            '571313185000300413',
            '571313174112223786',
            '571313161170038104',
