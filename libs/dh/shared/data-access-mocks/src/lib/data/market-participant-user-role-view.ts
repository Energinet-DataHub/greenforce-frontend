 ...
 */
import { EicFunction, GetUserRoleViewQuery } from '@energinet-datahub/dh/shared/domain/graphql';

export const marketParticipantUserRoleViewQuery: GetUserRoleViewQuery = {
  __typename: 'Query',
  userRoleView: [
    {
