...
@Component({
  selector: 'dh-admin-permission-detail-logs',
  standalone: true,
  templateUrl: './dh-admin-permission-detail-logs.component.html',
  styleUrls: ['./dh-admin-permission-detail-logs.component.scss'],
