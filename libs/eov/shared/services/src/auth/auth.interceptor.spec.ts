...
import { EovAuthorizationInterceptor, eovAuthorizationInterceptorProvider } from './auth.interceptor';
...
describe(EovAuthorizationInterceptor, () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [eovAuthorizationInterceptorProvider],
    });
