...
using Energinet.DataHub.WebApi.Modules.ElectricityMarket.Mappers;
...
namespace Energinet.DataHub.WebApi.Modules.ElectricityMarket.Measurements;
...
public static partial class MeasurementOperations
{
    ...
    {
        var sendMeasurementsRequestCommandV1 = new SendMeasurementsCommandV1(input.MapToSendMeasurementsV1());
