...
public static class SettlementGroupMapper
{
    public static int? MapToDto(this DataHub.ElectricityMarket.Abstractions.Shared.SettlementGroup settlementGroup)
    {
