...
public static class TimeResolutionMapper
{
    public static string MapToDto(this DataHub.ElectricityMarket.Abstractions.Shared.TimeResolution timeResolution)
    {
