...
/// <summary>
/// GraphQL type for BRS-011 incorrect move-in processes.
/// </summary>
[ObjectType<IncorrectMoveInProcess>]
public static partial class IncorrectMoveInNode
{
    static partial void Configure(IObjectTypeDescriptor<IncorrectMoveInProcess> descriptor)
    {
        descriptor
            .Name("IncorrectMoveInProcess")
        ...
        descriptor
            ...
            .Resolve((ctx, ct) => MeteringPointProcessNode.GetAvailableActionsAsync(
                ctx.Parent<IncorrectMoveInProcess>().Process,
