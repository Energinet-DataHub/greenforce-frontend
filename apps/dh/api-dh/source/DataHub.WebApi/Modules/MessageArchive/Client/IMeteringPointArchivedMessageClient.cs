...
using Energinet.DataHub.WebApi.Model.MeteringPointArchivedMessages;
...
/// <summary>
/// Client for getting metering point archived messages.
/// </summary>
public interface IMeteringPointArchivedMessageClient
{
    /// <summary>
