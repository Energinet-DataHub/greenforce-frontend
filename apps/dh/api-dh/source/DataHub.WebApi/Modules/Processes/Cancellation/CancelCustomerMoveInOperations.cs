...
public static class CancelCustomerMoveInOperations
{
    [Mutation]
    [Authorize(Roles = ["metering-point:move-in"])]
    public static async Task<bool> CancelCustomerMoveInAsync(
        ...
        CancellationToken ct)
    {
        ...
        return result.IsSuccess
            ? true
            : throw new GraphQLException("Command CancelCustomerMoveIn failed");
    }
}
