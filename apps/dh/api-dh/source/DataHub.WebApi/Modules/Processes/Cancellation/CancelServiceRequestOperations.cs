...
public static class CancelServiceRequestOperations
{
    [Mutation]
    [Authorize(Roles = ["metering-point:service-request-request"])]
    public static async Task<bool> CancelServiceRequestAsync(
        ...
        CancellationToken ct)
    {
        ...
        return result.IsSuccess
            ? true
            : throw new GraphQLException("Command CancelServiceRequest failed");
    }
}
