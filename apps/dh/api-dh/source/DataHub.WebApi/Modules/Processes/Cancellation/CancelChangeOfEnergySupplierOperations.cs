...
public static class CancelChangeOfEnergySupplierOperations
{
    [Mutation]
    [Authorize(Roles = ["metering-point:change-of-supplier"])]
    public static async Task<bool> CancelChangeOfEnergySupplierAsync(
        ...
        CancellationToken ct)
    {
        ...
        return result.IsSuccess
            ? true
            : throw new GraphQLException("Command CancelChangeOfEnergySupplier failed");
    }
}
