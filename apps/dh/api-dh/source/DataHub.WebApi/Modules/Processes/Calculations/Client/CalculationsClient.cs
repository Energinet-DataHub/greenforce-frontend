...
using Energinet.DataHub.ProcessManager.Abstractions.Api.OrchestrationInstance;
    ...
    : ICalculationsClient
{
        ...
        CancellationToken ct = default)
    {
        ...
        var query = new CalculationsQueryV1(userIdentity)
        {
            ...
            // For aggregation, find any existing external balance fixing (not just aggregations),
            ...
            // this should match any balance fixing (or later corrections).
