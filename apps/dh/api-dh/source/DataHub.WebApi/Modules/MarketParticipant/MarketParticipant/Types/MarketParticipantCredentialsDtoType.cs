...
{
    private static readonly string _controllerName = "MarketParticipant";

    public static string? GetAssignCertificateCredentialsUrl(
        ...
        [Service] LinkGenerator linkGenerator) => linkGenerator.GetUriByAction(
            ...
            _controllerName,
            new { marketParticipantId });

    public static string? GetRemoveMarketParticipantCredentialsUrl(
        Guid marketParticipantId,
        [Service] IHttpContextAccessor httpContext,
        [Service] LinkGenerator linkGenerator) => linkGenerator.GetUriByAction(
            httpContext.HttpContext!,
            "RemoveMarketParticipantCredentials",
            _controllerName,
            new { marketParticipantId });
}
