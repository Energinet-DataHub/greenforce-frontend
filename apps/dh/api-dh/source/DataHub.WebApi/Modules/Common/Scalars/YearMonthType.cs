...
public sealed class YearMonthType : ScalarType<YearMonth, StringValueNode>
{
    public YearMonthType()
        : base("YearMonth")
    {
        Description = "Represents a year and month";
    }
    ...
    public override bool TrySerialize(object? runtimeValue, out object? resultValue)
    {
        ...
        if (runtimeValue is YearMonth yearMonth)
        {
            resultValue = yearMonth.ToString(YearMonthPattern.Iso.PatternText, null);
            return true;
        }
    ...
    protected override YearMonth ParseLiteral(StringValueNode valueSyntax)
