...
namespace Energinet.DataHub.WebApi.Clients.MarketParticipant.v1
{
    ...
    public partial interface IMarketParticipantClient_V1
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ActorDelegationPutAsync(StopProcessDelegationOldDto? body, string? api_version = null);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ActorDelegationPutAsync(StopProcessDelegationOldDto? body, System.Threading.CancellationToken cancellationToken, string? api_version = null);
    ...
    public partial class MarketParticipantClient_V1 : IMarketParticipantClient_V1
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task ActorDelegationPutAsync(StopProcessDelegationOldDto? body, string? api_version = null)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task ActorDelegationPutAsync(StopProcessDelegationOldDto? body, System.Threading.CancellationToken cancellationToken, string? api_version = null)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.3.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class StopProcessDelegationOldDto
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; } = default!;
