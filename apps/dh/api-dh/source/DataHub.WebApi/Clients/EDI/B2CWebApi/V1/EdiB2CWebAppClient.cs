...
namespace Energinet.DataHub.Edi.B2CWebApp.Clients.v1
{
    ...
    public partial interface IEdiB2CWebAppClient_V1
    {
        ...
        System.Threading.Tasks.Task<Stream> ArchivedMessageGetDocumentAsync(string id = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class EdiB2CWebAppClient_V1 : IEdiB2CWebAppClient_V1
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Stream> ArchivedMessageGetDocumentAsync(string id = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
