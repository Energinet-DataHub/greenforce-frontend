...
namespace Energinet.DataHub.WebApi.Clients.Wholesale.v3
{
    ...
    public partial interface IWholesaleClient_V3
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<BatchDtoV2> GetBatchAsync(System.Guid batchId, string api_version = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<BatchDtoV2>> SearchBatchesAsync(BatchSearchDtoV2 body, string api_version = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class WholesaleClient_V3 : IWholesaleClient_V3
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<BatchDtoV2> GetBatchAsync(System.Guid batchId, string api_version = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (batchId == null)
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<BatchDtoV2>> SearchBatchesAsync(BatchSearchDtoV2 body, string api_version = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/v3/batches/search?");
            if (api_version != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("api-version") + "=").Append(System.Uri.EscapeDataString(ConvertToString(api_version, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class BatchSearchDtoV2
    {
        [Newtonsoft.Json.JsonConstructor]

        public BatchSearchDtoV2(BatchState @filterByExecutionState, System.Collections.Generic.ICollection<string> @filterByGridAreaCodes, System.DateTimeOffset? @maxExecutionTime, System.DateTimeOffset? @minExecutionTime, System.DateTimeOffset? @periodEnd, System.DateTimeOffset? @periodStart)

        {

            this.FilterByGridAreaCodes = @filterByGridAreaCodes;

            this.FilterByExecutionState = @filterByExecutionState;
        ...
        }    [Newtonsoft.Json.JsonProperty("filterByGridAreaCodes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> FilterByGridAreaCodes { get; }

        [Newtonsoft.Json.JsonProperty("filterByExecutionState", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public BatchState FilterByExecutionState { get; }

        [Newtonsoft.Json.JsonProperty("minExecutionTime", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? MinExecutionTime { get; }

        [Newtonsoft.Json.JsonProperty("maxExecutionTime", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
