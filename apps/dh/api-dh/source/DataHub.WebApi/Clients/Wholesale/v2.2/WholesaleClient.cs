...
namespace Energinet.DataHub.WebApi.Clients.Wholesale.v2_2
{
    ...
    public partial class WholesaleClient_V2_2 : IWholesaleClient_V2_2
    {
        ...
        public virtual async System.Threading.Tasks.Task<ProcessStepResultDto> ProcessStepResultAsync(string api_version, ProcessStepResultRequestDtoV2 body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/v2.2/ProcessStepResult?");
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ProcessStepResultRequestDtoV2
    {
        [Newtonsoft.Json.JsonConstructor]

        public ProcessStepResultRequestDtoV2(System.Guid @batchId, string @gln, string @gridAreaCode, TimeSeriesType @timeSeriesType)
