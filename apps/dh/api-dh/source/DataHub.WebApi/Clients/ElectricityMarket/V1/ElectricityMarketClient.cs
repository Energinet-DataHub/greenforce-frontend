...
namespace Energinet.DataHub.WebApi.Clients.ElectricityMarket.v1
{
    ...
    public partial interface IElectricityMarketClient_V1
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MeteringPointDto>> MeteringPointDebugAsync(string? gridAreaCode, string? actorNumber, string? actorRole, MarketRole? marketRole, string? api_version = null);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MeteringPointDto>> MeteringPointDebugAsync(string? gridAreaCode, string? actorNumber, string? actorRole, MarketRole? marketRole, System.Threading.CancellationToken cancellationToken, string? api_version = null);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MeteringPointDto>> MeteringPointDebugAsync(string? gridAreaCode, string? actorNumber, string? actorRole, MarketRole? marketRole, string? api_version = null)
        {
            return MeteringPointDebugAsync(gridAreaCode, actorNumber, actorRole, marketRole, System.Threading.CancellationToken.None, api_version);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MeteringPointDto>> MeteringPointDebugAsync(string? gridAreaCode, string? actorNumber, string? actorRole, MarketRole? marketRole, System.Threading.CancellationToken cancellationToken, string? api_version = null)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
