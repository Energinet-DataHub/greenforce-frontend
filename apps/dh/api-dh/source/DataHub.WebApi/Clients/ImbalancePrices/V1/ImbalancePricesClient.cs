...
namespace Energinet.DataHub.WebApi.Clients.ImbalancePrices.v1
{
    ...
    public partial class ImbalancePricesClient_V1 : IImbalancePricesClient_V1
    {
        ...
        {
            return UploadAsync(imbalancePricesFile, System.Threading.CancellationToken.None, api_version);
        }
        ...
        {
            return DownloadAsync(fromDate, toDate, System.Threading.CancellationToken.None, api_version);
        }
        ...
        {
            return GetByMonthAsync(year, month, priceAreaCode, System.Threading.CancellationToken.None, api_version);
        }
        ...
        {
            return StatusAsync(fromDate, toDate, priceAreaCode, System.Threading.CancellationToken.None, api_version);
        }
        ...
        {
            return PingAsync(System.Threading.CancellationToken.None, api_version);
        }
        ...
        public virtual async System.Threading.Tasks.Task PingAsync(System.Threading.CancellationToken cancellationToken, string? api_version = null)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "ping-imbalance-prices/ping"
                    urlBuilder_.Append("ping-imbalance-prices/ping");
                    urlBuilder_.Append('?');
                    if (api_version != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("api-version")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(api_version, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        {
            return AuthorizedPingAsync(System.Threading.CancellationToken.None, api_version);
        }
        ...
        public virtual async System.Threading.Tasks.Task AuthorizedPingAsync(System.Threading.CancellationToken cancellationToken, string? api_version = null)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "ping-imbalance-prices/authorized-ping"
                    urlBuilder_.Append("ping-imbalance-prices/authorized-ping");
                    urlBuilder_.Append('?');
                    if (api_version != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("api-version")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(api_version, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
