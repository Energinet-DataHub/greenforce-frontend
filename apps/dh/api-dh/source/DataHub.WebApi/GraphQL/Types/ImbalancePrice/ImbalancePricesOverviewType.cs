...
{
    protected override void Configure(IObjectTypeDescriptor<ImbalancePricesOverview> descriptor)
    {
        descriptor.Name("ImbalancePricesOverview");

        descriptor
            .Field("uploadImbalancePricesUrl")
