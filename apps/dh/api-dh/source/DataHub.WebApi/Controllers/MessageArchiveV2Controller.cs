...
[ApiController]
[Route("v2/MessageArchive")]
public class MessageArchiveV2Controller(IB2CClient b2CClient) : ControllerBase
{
    ...
    public async Task<IActionResult> GetDocumentByIdAsync(string id, CancellationToken cancellationToken)
    {
