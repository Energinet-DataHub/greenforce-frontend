...
namespace Energinet.DataHub.WebApi.Controllers
{
    [ApiController]
    [Route("v1/[controller]")]
    public class MarketParticipantGridAreaOverviewController : MarketParticipantControllerBase
    {
        private readonly IMarketParticipantClient _client;

        public MarketParticipantGridAreaOverviewController(IMarketParticipantClient client)
        {
            _client = client;
        }
