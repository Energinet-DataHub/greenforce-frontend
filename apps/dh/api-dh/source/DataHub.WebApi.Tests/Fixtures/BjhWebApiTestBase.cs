...
public abstract class BjhWebApiTestBase
    : IClassFixture<BjhWebApiFactory>, IAsyncLifetime
{
    public HttpClient Client { get; set; }

    public BjhWebApiFactory Factory { get; }

    public BjhWebApiTestBase(BjhWebApiFactory factory)
    {
        Factory = factory;
