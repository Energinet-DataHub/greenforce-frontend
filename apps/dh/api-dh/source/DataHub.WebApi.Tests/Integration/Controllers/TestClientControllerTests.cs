...
{
    public class TestClientControllerTests : IClassFixture<WebApplicationFactory<Startup>>
    {
#pragma warning disable
        public TestClientControllerTests(WebApplicationFactory<Startup> factory)
        {
            Fixture = new Fixture();
        ...
        [Fact]
        public async Task When_MessageTemplate_Requested_And_Found_Then_StatusCode_IsOK()
        {
            // Arrange
            const string templateId = "47fd7258-bf98-4146-a04f-5014f0b1a324";
            var requestUrl = $"/v1/TestClient/GetSendMessageTemplateDTO?templateId={templateId}";
