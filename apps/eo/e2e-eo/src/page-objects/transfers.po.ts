...
export class TransfersPo {
  ...
  private newAgreementWalletDepositEndpointInput =
    '[data-testid="new-agreement-wallet-deposit-endpoint-input"]';
  ...
  enterDetailsForNewAgreement() {
    ...
    cy.get(this.newAgreementWalletDepositEndpointInput).type(
      this.testBase64EncodedWalletDepositEndpoint
    );
  }
