...
export class LoginPo {
  private test1 = '[value="Frontend e2e test 1"]';
  private charlotte = '[value="Charlotte CSR"]';
  private test2 = '[value="Frontend e2e test 2"]';

  // Interaction
  clickTest1Login = () => cy.get(this.test1, { timeout: 10000 }).click();
  clickTest2Login = () => cy.get(this.test2, { timeout: 10000 }).click();
